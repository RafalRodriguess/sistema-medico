...
class CreateContasPagarGerarFinanceiroRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'conta_caixa.*.conta_id' => ['required', 'exists:contas,id'],
            'conta_caixa.*.valor' => ['nullable', 'required_with:conta_caixa.*.conta_id'],
