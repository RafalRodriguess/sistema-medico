...
class CriarComercialUsuarioRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'usuario_id' => ['nullable', Rule::unique('comercial_has_usuarios', 'usuario_id')->where('comercial_id', $this->comercial->id)],
        ...
        // 'required_unless:campo',
        // 'required_unless:campo,valor',
        // Rule::requiredIf(function () {
        //     if(Paciente::where()->find(''-) == 'valor'){
