...
class CreateMaquinasCartaoRequest extends FormRequest
{
    /**
    ...
    public function rules(Request $request)
    {
        return [
            ...
            'codigo' => [
                'required',
                Rule::unique('maquinas_cartoes', 'codigo')->where('instituicao_id', $request->session()->get('instituicao'))->whereNull('deleted_at')
            ],
