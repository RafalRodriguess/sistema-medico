...
class CriarRequestConvenio extends FormRequest
{
    /**
    ...
    {
        return [
            'nome' => ['required', Rule::unique('convenios', 'nome')->whereNull('deleted_at')->where('instituicao_id', $request->session()->get('instituicao'))],
            'descricao' => ['nullable'],
