...
class ModeloProntuarioPesquisa extends Component
{
    ...
    public function render()
    {
        ...
        $this->performQuery();  
        return view('livewire.instituicao.modelo-prontuario-pesquisa', [
    ...
    {
        $query = ModeloProntuario::search($this->pesquisa, $this->instituicao, $this->usuario->id);
