...
class AgendamentosPesquisa extends Component
{
    ...
    public function render()
    {
        ...
        $view = view('livewire.instituicao.agendamentos-pesquisa', ['medico' => $medico]);
    ...
    private function performQuery(): void
    {
        ...
        if($this->agenda){
            ...
            $this->hora_avulsa = $this->agenda->hora_inicio;
        ...
        ->when($this->setor_id, function($q) {
            ...
            $q->whereHas('instituicoesAgenda', function($q){
                $q->whereJsonContains("dias_unicos", ['setor_id' => $this->setor_id]);
                $q->orWhere('setor_id', $this->setor_id);
