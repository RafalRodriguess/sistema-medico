...
class ModeloLaudoPesquisa extends Component
{
    ...
    public function render()
    {
        ...
        $this->performQuery();  
        return view('livewire.instituicao.modelo-laudo-pesquisa', [
    ...
    {
        $query = ModeloLaudo::search($this->pesquisa, $this->instituicao, $this->usuario->id);
