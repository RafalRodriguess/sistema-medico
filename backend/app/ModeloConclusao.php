...
class ModeloConclusao extends Model
{
    use SoftDeletes;
    use TraitLogInstituicao;

    protected $table = "modelos_conclusoes";
    ...
    public function motivoConclusao()
    {
        return $this->belongsTo(MotivoConclusao::class, 'motivo_conclusao_id');
    }
