<div class="">
    ...
    <form action="javascript:void(0)" id="FormTitular">
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="form-group" style="margin-bottom: 0px !important;">
                    <a href="{{ route('comercial.fretes_retirada.create') }}">
    ...
    <table class="tablesaw table-bordered table-hover table">
        <thead>
            <tr>
                ...
                <th scope="col" data-tablesaw-sortable-col data-tablesaw-sortable-default-col data-tablesaw-priority="1">Rua</th>
                <th scope="col" data-tablesaw-sortable-col data-tablesaw-sortable-default-col data-tablesaw-priority="1">Numero</th>
                ...
                <th scope="col" data-tablesaw-sortable-col data-tablesaw-sortable-default-col data-tablesaw-priority="1">Estado</th>
                <th scope="col" data-tablesaw-sortable-col data-tablesaw-sortable-default-col data-tablesaw-priority="1">CEP</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('comercial.fretes_retirada.edit', [$item]) }}">
                    ...
                    <form action="{{ route('comercial.fretes_retirada.destroy', [$item]) }}" method="post" class="d-inline form-excluir-registro">
                        @method('delete')
                        @csrf
