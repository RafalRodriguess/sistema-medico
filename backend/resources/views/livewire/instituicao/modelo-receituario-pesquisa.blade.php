<div class="card-body">
    ...
    <form action="javascript:void(0)" id="FormTitular">
        <div class="row">
            ...
            @can('habilidade_instituicao_sessao', 'cadastrar_modelo_receituario')
                <div class="col-md-2">
                    <div class="form-group" style="margin-bottom: 0px !important;">
                        <a href="{{ route('instituicao.modeloReceituario.create') }}">
        ...
        <tbody>
            @foreach ($modelos as $modelo)
                <tr>
                    ...
                    <td>
                        @can('habilidade_instituicao_sessao', 'editar_modelo_receituario')
                            <a href="{{ route('instituicao.modeloReceituario.edit', [$modelo]) }}">
                        ...
                        @endcan
                        @can('habilidade_instituicao_sessao', 'excluir_modelo_receituario')
                            <form action="{{ route('instituicao.modeloReceituario.destroy', [$modelo]) }}" method="post" class="d-inline form-excluir-registro">
                                @method('delete')
                                @csrf
