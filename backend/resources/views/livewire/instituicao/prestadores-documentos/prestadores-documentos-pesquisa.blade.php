...
<div class="card-body">
    ...
    <form action="javascript:void(0)" id="FormTitular">
        <div class="row">
            ...
            @can('habilidade_instituicao_sessao', 'cadastrar_documento_prestador')
                <div class="col-md-2">
                    <div class="form-group" style="margin-bottom: 0px !important;">
                        <a href="{{ route('instituicao.prestadores.documentos.create', [$prestador]) }}">
        ...
        <tbody>
            @foreach($prestador_documentos as $documento)
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a href="{{ route('instituicao.prestadoresDocumentosDownload', $documento->file_path_name) }}">
                ...
                <tr>
                    ...
                    <td>
                        @can('habilidade_instituicao_sessao', 'editar_documento_prestador')
                            <a href="{{ route('instituicao.prestadores.documentos.edit', [$prestador, $documento]) }}">
                        ...
                        @endcan
                        @can('habilidade_instituicao_sessao', 'excluir_documento_prestador')
                            <form action="{{ route('instituicao.prestadores.documentos.destroy', [$prestador, $documento]) }}" method="post" class="d-inline form-excluir-registro">
                                @method('delete')
                                @csrf
