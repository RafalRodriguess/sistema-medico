<div class="card-body">
    ...
    <form action="javascript:void(0)" id="FormTitular">
        <div class="row">
            ...
            @can('habilidade_instituicao_sessao', 'cadastrar_modelo_exame')
                <div class="col-md-2">
                    <div class="form-group" style="margin-bottom: 0px !important;">
                        <a href="{{ route('instituicao.modeloExame.create') }}">
        ...
        <tbody>
            @foreach ($modelos as $modelo)
                <tr>
                    ...
                    <td>
                        @can('habilidade_instituicao_sessao', 'editar_modelo_exame')
                            <a href="{{ route('instituicao.modeloExame.edit', [$modelo]) }}">
                        ...
                        @endcan
                        @can('habilidade_instituicao_sessao', 'excluir_modelo_exame')
                            <form action="{{ route('instituicao.modeloExame.destroy', [$modelo]) }}" method="post" class="d-inline form-excluir-registro">
                                @method('delete')
                                @csrf
