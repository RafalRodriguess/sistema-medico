    ...
    <form action="javascript:void(0)" id="FormTitular">
        <div class="row">
            ...
            @can('habilidade_instituicao_sessao', 'cadastrar_documentos_fornecedores')
                <div class="col-md-2">
                    <div class="form-group" style="margin-bottom: 0px !important;">
                        <a href="{{ route('instituicao.fornecedores.documentos.create', [$fornecedor]) }}">
        ...
        <tbody>
            @foreach($documentos as $documento)
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a href="{{ route('instituicao.fornecedoresDocumentosDownload', $documento->file_path_name) }}">
                                    <button type="button" class="btn btn-success download-fornecedores-documentos">Baixar <i class="mdi mdi-download"></i></button>
                                </a>
                ...
                <tr>
                    ...
                    <td>
                        @can('habilidade_instituicao_sessao', 'editar_documentos_fornecedores')
                            <a href="{{ route('instituicao.fornecedores.documentos.edit', [$fornecedor, $documento]) }}">
                        ...
                        @endcan
                        @can('habilidade_instituicao_sessao', 'excluir_documentos_fornecedores')
                            <form action="{{ route('instituicao.fornecedores.documentos.destroy', [$fornecedor, $documento]) }}" method="post" class="d-inline form-excluir-registro">
                                @method('delete')
                                @csrf
