<div class="card-body">
    ...
    <form action="javascript:void(0)" id="FormTitular">
        <div class="row">
            ...
            @can('habilidade_instituicao_sessao', 'cadastrar_modelo_atestado')
                <div class="col-md-2">
                    <div class="form-group" style="margin-bottom: 0px !important;">
                        <a href="{{ route('instituicao.modeloAtestado.create') }}">
        ...
        <tbody>
            @foreach ($modelos as $modelo)
                <tr>
                    ...
                    <td>
                        @can('habilidade_instituicao_sessao', 'editar_modelo_atestado')
                            <a href="{{ route('instituicao.modeloAtestado.edit', [$modelo]) }}">
                        ...
                        @endcan
                        @can('habilidade_instituicao_sessao', 'excluir_modelo_atestado')
                            <form action="{{ route('instituicao.modeloAtestado.destroy', [$modelo]) }}" method="post" class="d-inline form-excluir-registro">
                                @method('delete')
                                @csrf
