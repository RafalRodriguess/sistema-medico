<div class="card-body">
    ...
    <form action="javascript:void(0)" id="FormTitular">
            <div class="row">
                  ...
                  @can('habilidade_admin', 'cadastrar_atendimentos')
                                                      <div class="col-md-2">
                    <div class="form-group" style="margin-bottom: 0px !important;">
            ...
            <tbody>
                @foreach($atendimentos as $atendimento)
                    <tr>
                        ...
                        <td>
                            @can('habilidade_admin', 'habilidades_atendimentos')
                                <a href="{{ route('admin.atendimentos.habilidades', [$atendimento]) }}">
                            ...
                            @endcan
                            @can('habilidade_admin', 'editar_atendimentos')
                                <a href="{{ route('admin.atendimentos.edit', [$atendimento]) }}">
                                        <button type="button" class="btn btn-xs btn-secondary" aria-haspopup="true" aria-expanded="false"
                            ...
                            @can('habilidade_admin', 'excluir_atendimentos')
                                <form action="{{ route('admin.atendimentos.destroy', [$atendimento]) }}" method="post" class="d-inline form-excluir-registro">
                                    @method('delete')
                                    @csrf
