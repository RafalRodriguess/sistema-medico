...
@section('conteudo')
                ...
                <div class="row page-titles">
                        ...
                        <h3 class="text-themecolor m-b-0 m-t-0">Usuarios #{{$comercial->id}}  {{$comercial->nome_fantasia}}</h3>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('comercial.index')}}">Comercial</a></li>
                                <li class="breadcrumb-item"><a href="javascript:void(0)">{{$comercial->nome_fantasia}}</a></li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <!-- Column -->
                            <div class="card">
                                @livewire('admin.usuario-comercial-pesquisa', ['comercial' => $comercial])
                            </div>
                            <!-- Column -->
