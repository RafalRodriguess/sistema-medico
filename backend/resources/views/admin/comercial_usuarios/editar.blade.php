...
@section('conteudo')
    @component('components/page-title', [
        'titulo' => "Editar Administrador #{$comercialUsuario->id} {$comercialUsuario->nome}",
        'breadcrumb' => [
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('comercial_usuarios.update', [$comercial, $comercialUsuario]) }}" method="post" enctype="multipart/form-data">
                @method('put')
                @csrf

                {{-- <input type="hidden" value="{{$comercial->id}}" name="comercial_id"> --}}
...
@push('scripts')
    ...
    var blobImage;
        ...
        $("form").submit(function(e){
            ...
            $.ajax("{{ route('comercial_usuarios.update', [$comercial, $comercialUsuario]) }}", {
                method: "POST",
                data: formData,
                processData: false,
                contentType: false,
