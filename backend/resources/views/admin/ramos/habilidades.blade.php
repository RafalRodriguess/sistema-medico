...
@section('conteudo')
    @component('components/page-title', [
        'titulo' => "Editar hablidade Ramo #{$ramo->id} {$ramo->descricao}",
        'breadcrumb' => [
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('ramos.habilidade', [$ramo]) }}" method="post">
                @csrf
                                      ...
                                      @php($habilidade = in_array($hab->id, array_column($selecionadas, 'habilidade_id')))
                                        <div class="row habilidade" style="margin-bottom: 30px!important">
                                            ...
                                            <div class="demo-radio-button col-md-6">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <input class="permitir" name="habilidades[{{ $hab->id }}]" type="radio" id="radio_{{ $hab->nome_unico }}_1" @if ($habilidade) checked @endif value="1" />
                                                        <label for="radio_{{ $hab->nome_unico }}_1">Permitir</label>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <input class="negar" name="habilidades[{{ $hab->id }}]" type="radio" id="radio_{{ $hab->nome_unico }}_2" @if (!$habilidade) checked @endif value="0" />
