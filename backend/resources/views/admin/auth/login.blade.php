        ...
        <div class="login-register" style="background: #f5f5f5;">
        		      ...
        		      <div class="row" style="padding-bottom: 25px;">
                            <div class="col-xs-12 col-sm-12 col-md-12 m-t-10 text-center">
                                <img src="{{ asset('material/assets/images/icon-login.png') }}" width="140" >
                            </div>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal form-material" id="loginform" method="post" action="{{ route('admin.login') }}">
                        ...
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control" type="text" required="" alt="cpf" name="cpf" placeholder="Administrador"> </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
        ...
        $(function(){
            ...
            $('#enviar').on('click',function(){
                ...
                if($('#reset_email').val().length>0){
                    $.ajax({
                    url: "{{route('admin.send_token_recover_password')}}",
                    method: 'post',
                    dataType: 'json',
                    data: {
