...
@section('conteudo')
    @component('components/page-title', [
        'titulo' => "Editar hablidade Administrador #{$instituicaoUsuario->id} {$instituicaoUsuario->nome} #{$instituicao->id} {$instituicao->nome}",
        'breadcrumb' => [
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('habilidadesInstituicao', [$instituicao, $instituicaoUsuario]) }}" method="post">
                @method('put')
                @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="ibox-content">
                                    @foreach ($hab_grupo->instituicaoHabilidades as $hab)
                                        @php($habilidade = $instituicaoUsuario->instituicaoHabilidades->where("nome_unico", $hab->nome_unico)->where("pivot.instituicao_id", $instituicao->id)->first())
