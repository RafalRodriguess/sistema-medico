...
@section('conteudo')
                ...
                <div class="row page-titles">
                        ...
                        <h3 class="text-themecolor m-b-0 m-t-0">Usuarios #{{$instituicao->id}}  {{$instituicao->nome}}</h3>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('instituicoes.index')}}">Instituições</a></li>
                                <li class="breadcrumb-item"><a href="javascript:void(0)">{{$instituicao->nome}}</a></li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <!-- Column -->
                            <div class="card">
                                @livewire('admin.usuario-instituicao-pesquisa', ['instituicao' => $instituicao])
                            </div>
                            <!-- Column -->
