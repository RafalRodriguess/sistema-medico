...
@section('conteudo')
    @component('components/page-title', [
        ...
        'breadcrumb' => [
            'Prestador' => route('prestadores.documentos.index', [$prestador]),
            'Novo',
        ],
    ])
    @endcomponent
    ...
    <div class="card col-sm-12">
        <div class="card-body">
            <form action="{{ route('prestadores.documentos.store', [$prestador]) }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group text-right">
                    <a href="{{ route('prestadores.index', [$prestador]) }}">
