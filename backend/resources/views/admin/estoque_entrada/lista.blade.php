...
@section('conteudo')
                ...
                <div class="row page-titles">
                        <div class="col-md-5 col-8 align-self-center">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Estoque Entrada</a></li>
                                {{-- <li class="breadcrumb-item active">Estoque Entrada</li> --}}
                            </ol>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <!-- Column -->
                            <div class="card">
                                @livewire('admin.estoque-entrada')
                            </div>
                            <!-- Column -->
