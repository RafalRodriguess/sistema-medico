...
@section('conteudo')
    @component('components/page-title', [
        'titulo' => "Editar hablidade perfil #{$perfisUsuario->id} {$perfisUsuario->descricao}",
        'breadcrumb' => [
                    ...
                    <div class="row pesquisar">
                        ...
                        <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <select class="form-control" name="categoria_pesquisa" id="categoria_pesquisa" id="categoria_pesquisa">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('perfis_usuarios.habilidades', [$perfisUsuario]) }}" method="post">
                @method('put')
                @csrf
                                            ...
                                            <div class="demo-radio-button col-md-6">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        @if ($perfisUsuario->habilidades->where("nome_unico", $hab->nome_unico)->first())
                                                            checked
                                                        @endif
                                                        value="1" />
