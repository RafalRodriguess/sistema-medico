...
@section('conteudo')
    @component('components/page-title', [
        'titulo' => "Editar conta bancária #{$comercial->id} {$comercial->nome_fantasia}",
        'breadcrumb' => [
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('comercial.banco.update', [$comercial]) }}" method="post" >
                @method('put')
                @csrf
                @php
                $bancos = buscarBancos();
                ...
                <div class="form-group @error('banco_id') has-danger @enderror">
                    <label class="control-label">Banco</label>
                            <input type="hidden" name="banco_nome" id="banco_nome" value="{{ old('banco_nome', $comercial->banco ? $comercial->banco->bank_name : '') }}" />
                            ...
                            @foreach ($bancos as $banco_id => $banco_nome)
                                <option value="{{ $banco_id }}"
                                    @if($comercial->banco && $comercial->banco->bank_code == $banco_id) selected="selected" @endif
                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="form-group @if($errors->has('agencia')) has-danger @endif">
                            ...
                            <input type="text" name="agencia" value="{{ old('agencia', $comercial->banco ? $comercial->banco->agencia : '') }}"
                    ...
                    <div class="col-md-3">
                        <div class="form-group @if($errors->has('agencia_dv')) has-danger @endif">
                            ...
                            <input type="text" name="agencia_dv" value="{{ old('agencia_dv', $comercial->banco ? $comercial->banco->agencia_dv : '') }}"
                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="form-group @if($errors->has('conta')) has-danger @endif">
                            ...
                            <input type="text" name="conta" value="{{ old('conta', $comercial->banco ? $comercial->banco->conta : '') }}"
                    ...
                    <div class="col-md-3">
                        <div class="form-group @if($errors->has('conta_dv')) has-danger @endif">
                            ...
                            <input type="text" name="conta_dv" value="{{ old('conta_dv', $comercial->banco ? $comercial->banco->conta_dv : '') }}"
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-3">
                        <label class="i-checks">
                            <input type="radio" name="type" @if(old('type') == 'conta_corrente') checked @elseif($comercial->banco && $comercial->banco->type == 'conta_corrente') checked @elseif(!$comercial->banco) checked @endif  value="conta_corrente" > Conta corrente
                        </label>
                    </div>
                    <div class="col-md-3">
                        <label class="i-checks">
                            <input type="radio" name="type" value="conta_poupanca" @if(old('type') == 'conta_poupanca') checked @elseif($comercial->banco && $comercial->banco->type == 'conta_poupanca') checked  @endif > Conta poupança
                        </label>
                    </div>
                    <div class="col-md-3">
                        <label class="i-checks">
                            <input type="radio" name="type" value="conta_corrente_conjunta" @if(old('type') == 'conta_corrente_conjunta') checked @elseif($comercial->banco && $comercial->banco->type == 'conta_corrente_conjunta') checked  @endif> Conta corrente conjunta
                        </label>
                    </div>
                    <div class="col-md-3">
                        <label class="i-checks">
                            <input type="radio" name="type" value="conta_poupanca_conjunta" @if(old('type') == 'conta_poupanca_conjunta') checked @elseif($comercial->banco && $comercial->banco->type == 'conta_poupanca_conjunta') checked  @endif> Conta poupança conjunta
                        </label>
                    </div>
                    @error('type')
                        <div class="form-control-feedback">{{ $message }}</div>
                ...
                <div class="form-group @if($errors->has('nome_titular')) has-danger @endif">
                    ...
                    <input type="text" name="nome_titular" value="{{ old('nome_titular', $comercial->banco ? $comercial->banco->nome_titular : '') }}"
                ...
                <div class="form-group @if($errors->has('documento_titular')) has-danger @endif">
                    ...
                    <input type="text" name="documento_titular" value="{{ old('documento_titular', $comercial->banco ? $comercial->banco->documento_titular : '') }}"
