...
@section('conteudo')
                ...
                <div class="row page-titles">
                        <div class="col-md-5 col-8 align-self-center">
                            <h3 class="text-themecolor m-b-0 m-t-0">Trações</h3>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Cadastros</a></li>
                                <li class="breadcrumb-item active">Trações</li>
                            </ol>
                        </div>
                                    ...
                                    <table class="tablesaw table-bordered table-hover table" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-sortable-switch data-tablesaw-minimap data-tablesaw-mode-switch>
                                        ...
                                        <tbody>
                                            @foreach($tracoes as $tracao)
                                                <tr>
                                                    <td class="title"><a href="javascript:void(0)">{{ $tracao->id }}</a></td>
                                                    <td>{{ $tracao->descricao }}</td>
                                                    <td>

                                                            <a href="{{ route('tracoes.edit', [$tracao]) }}">
                                                            ...
                                                            <form action="{{ route('tracoes.destroy', [$tracao]) }}" method="post" class="d-inline form-excluir-registro">
                                                                @method('delete')
                                                                @csrf
