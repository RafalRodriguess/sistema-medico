                        ...
                        <div class="row">
                                ...
                                <div class="col-md-2">
                                        <div class="form-group @if($errors->has('km')) has-danger @endif">
                                            ...
                                            <input type="text" name="km" value="{{ old('km', $veiculo->km) }}" class="form-control @if($errors->has('km')) form-control-danger @endif">
                                            @if($errors->has('km'))
                                ...
                                <div class="col-md-2">
                                        <div class="form-group @if($errors->has('data_entrada')) has-danger @endif">
                                            ...
                                            <input type="text" name="data_entrada" value="{{ old('data_entrada', $veiculo->data_entrada) }}" class="form-control @if($errors->has('data_entrada')) form-control-danger @endif">
                                ...
                                <div class="col-md-2">
                                        <div class="form-group @if($errors->has('valor_compra')) has-danger @endif">
                                            ...
                                            <input type="text" name="valor_compra" value="{{ old('valor_compra', $veiculo->valor_compra) }}" class="form-control @if($errors->has('valor_compra')) form-control-danger @endif">
                                ...
                                <div class="col-md-2">
                                        <div class="form-group @if($errors->has('valor_fipe')) has-danger @endif">
                                            ...
                                            <input type="text" name="valor_fipe" value="{{ old('valor_fipe', $veiculo->valor_fipe) }}" class="form-control @if($errors->has('valor_fipe')) form-control-danger @endif">
                                ...
                                <div class="col-md-4">
                                        <div class="form-group @if($errors->has('valor_sugerido')) has-danger @endif">
                                            ...
                                            <input type="text" name="valor_sugerido" value="{{ old('valor_sugerido', $veiculo->valor_sugerido) }}" class="form-control @if($errors->has('valor_sugerido')) form-control-danger @endif">
