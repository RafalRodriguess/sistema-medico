...
@component('components/page-title', [
    'titulo' => "Editar Conta a Receber #{$contasReceber->id}",
    'breadcrumb' => [
...
@endcomponent
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('contas_receber.update', [$contasReceber]) }}" method="post">
                @method('put')
                @csrf
                ...
                <div class="form-body">
                                           ...
                                           <select class="select2 @error('contas_id') form-control-danger @enderror" name="contas_id"  style="width: 100%">
                                            ...
                                            @foreach ($contas as $conta)
                                                <option value="{{ $conta->id }}"
                                                    @if(old('contas_id', $contasReceber->contas_id) == $conta->id) selected="selected" @endif>
                                                    {{ $conta->descricao }}
                                                </option>
                                            @endforeach
                                           </select>
                                           ...
                                           <select class="select2 @error('planos_contas_id') form-control-danger @enderror" name="planos_contas_id"  style="width: 100%">
                                            ...
                                            @foreach ($planos_conta as $plano_conta)
                                                <option value="{{ $plano_conta->id }}"
                                                    @if(old('planos_contas_id', $contasReceber->planos_contas_id) == $plano_conta->id) selected="selected" @endif>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="tipo" class="form-control" data-placeholder="Selecione" tabindex="1">
                                        <option @if(old('tipo', (isset($contasReceber->cliente->nome) ? 'cliente' : '')) == 'cliente') selected="selected" @endif value="cliente">Vinculada a um cliente</option>
                                       ...
                                       <select class="select2 @error('clientes_id') form-control-danger @enderror" name="clientes_id"  style="width: 100%">
                                        ...
                                        @foreach ($clientes as $cliente)
                                            <option value="{{ $cliente->id }}"
                                                @if(old('clientes_id', $contasReceber->clientes_id) == $cliente->id) selected="selected" @endif>
                                                {{ $cliente->nome }}
                                            </option>
                                        @endforeach
                                       </select>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="data_competencia" alt="date" value="{{ old('data_competencia', $contasReceber->data_competencia->format("d/m/Y")) }}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="num_documento" value="{{ old('num_documento', $contasReceber->num_documento) }}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="descricao" name="descricao" value="{{ old('descricao', $contasReceber->descricao) }}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="form-control" data-placeholder="Selecione" tabindex="1" onchange="verifica_situacao_conta()">
                                    <option @if(old('status', $contasReceber->status) == 'aberta') selected="selected" @endif value="aberta">A receber</option>
                                    <option @if(old('status', $contasReceber->status) == 'quitada') selected="selected" @endif value="quitada">Recebida</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="data_vencimento" alt="date" value="{{ old('data_vencimento', $contasReceber->data_vencimento->format("d/m/Y")) }}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="valor_pagar" alt="money" value="{{ old('valor_pagar', $contasReceber->valor_pagar) }}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div id="info_pgto" style="{{ ($contasReceber->status == 'aberta') ? 'display:none' : '' }}">
                            ...
                            <div class="row">
                                               ...
                                               <select class="select2 @error('formas_pagamento_id') form-control-danger @enderror" name="formas_pagamento_id" id="formas_pagamento_id"  style="width: 100%" onchange="verifica_info_cheque()">
                                                @foreach ($formas_pagamento as $forma_pagamento)
                                                    <option value="{{ $forma_pagamento->id }}"
                                                        @if(old('formas_pagamento_id', $contasReceber->formas_pagamento_id) == $forma_pagamento->id) selected="selected" @endif>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        @php
                                        if(!empty($contasReceber->data_pagamento)):
                                        $data_pgto = $contasReceber->data_pagamento->format("d/m/Y");
                                        else:
                                        $data_pgto = '';
                                        endif;
                                        @endphp
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="valor_pagamento" alt="money" value="{{ old('valor_pagamento', $contasReceber->valor_pagamento) }}" class="form-control">
                                    </div>
                                </div>
                        ...
                        <div id="info_cheque" style="{{ (!empty($contasReceber->formas_pagamento_id && $contasReceber->formas_pagamento_id == 3) ? '' : 'display:none') }}">
                           ...
                           <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="banco_cheque" value="{{ old('banco_cheque', $contasReceber->banco_cheque) }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="num_cheque" value="{{ old('num_cheque', $contasReceber->num_cheque) }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="titular_cheque" value="{{ old('titular_cheque', $contasReceber->titular_cheque) }}" class="form-control">
                                </div>
                            </div>
