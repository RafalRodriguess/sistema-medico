                                    ...
                                    <table class="tablesaw table-bordered table-hover table" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-sortable-switch data-tablesaw-minimap data-tablesaw-mode-switch>
                                        ...
                                        <tbody>
                                            @foreach($contas_receber as $conta_receber)
                                                <tr>
                                                    <td class="title"><a href="javascript:void(0)">{{ $conta_receber->id }}</a></td>
                                                    <td>{{ (isset($conta_receber->cliente->nome) ? $conta_receber->cliente->nome : 'Avulso') }}</td>
                                                    <td>{{ $conta_receber->conta->descricao }}</td>
                                                    <td>{{ $conta_receber->plano_conta->descricao }}</td>
                                                    <td>{{ $conta_receber->descricao }}</td>
                                                    <td>{{ $conta_receber->status }}</td>
                                                    <td>R$ {{ $conta_receber->valor_pagar }}</td>
                                                    <td>

                                                            <a href="{{ route('contas_receber.edit', [$conta_receber]) }}" data-toggle="tooltip" data-placement="top" data-original-title="Editar/Baixar">
                                                            ...
                                                            <form action="{{ route('cancelar-conta-receber', [$conta_receber]) }}" method="post" class="d-inline form-excluir-registro">
                                                                {{-- @method('delete') --}}
                                                                @csrf
