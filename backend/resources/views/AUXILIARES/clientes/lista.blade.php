                                    ...
                                    <table class="tablesaw table-bordered table-hover table" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-sortable-switch data-tablesaw-minimap data-tablesaw-mode-switch>
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-sortable-default-col data-tablesaw-priority="3">Telefone principal</th>
                                        ...
                                        <tbody>
                                            @foreach($clientes as $cliente)
                                                <tr>
                                                    <td class="title"><a href="javascript:void(0)">{{ $cliente->id }}</a></td>
                                                    <td>{{ $cliente->nome }}</td>
                                                    ...
                                                    <td>
                                                            ...
                                                            <form action="{{ route('clientes.destroy', [$cliente]) }}" method="post" class="d-inline form-excluir-registro">
                                                                @method('delete')
                                                                @csrf
