...
@section('conteudo')
    @component('components/page-title',
        [
            'titulo' => "Editar produto da entrada de estoque #{$estoqueEntradaProduto->id}",
            'breadcrumb' => [
                'Produtos da entrada de estoque' => route('instituicao.estoque_entrada_produtos.index', [$entradaEstoque]),
                'Editar produto da entrada de estoque',
            ],
        ])
    @endcomponent
    ...
    <div class="card">
        <div class="card-body">
            <form
                action="{{ route('instituicao.estoque_entrada_produtos.update', [$entradaEstoque, $estoqueEntradaProduto]) }}"
                method="POST">
                <div class="row">
                    @method('post')
                    @csrf
                    ...
                    <div class="col-sm-6">
                        <div class="form-group @error('id_produto') has-danger @enderror">
                            ...
                            <select name="id_produto" class="form-control @error('id_produto') form-control-danger @enderror">
                                <option value="">Selecione Produto</option>
                                @foreach ($produtos as $key => $produto)
                                    <option value="{{ $produto->id }}"
                                        {{ $estoqueEntradaProduto->id_produto == old('id_produto', $produto->id) ? "selected='selected'" : '' }}>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group @if ($errors->has('lote')) has-danger @endif">
                            ...
                            <input type="text" name="lote" value="{{ old('lote', $estoqueEntradaProduto->lote) }}"
                    ...
                    <div class="col-sm-4 col-md-3">
                        <div class="form-group @if ($errors->has('quantidade')) has-danger @endif">
                            ...
                            <input type="number" min="0" name="quantidade"
                                value="{{ old('quantidade', $estoqueEntradaProduto->quantidade) }}"
                    ...
                    <div class="form-group col-sm-4 col-md-3 @if ($errors->has('valor_custo')) has-danger @endif">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                ...
                                name="valor_custo" id="valor_custo"
                                value="{{ (float) old('valor_custo', $estoqueEntradaProduto->valor_custo) * 100 }}">
                        </div>
                    ...
                    <div class="form-group col-sm-4 col-md-3 @if ($errors->has('valor')) has-danger @endif">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                ...
                                name="valor" id="valor"
                                value="{{ (float) old('valor', $estoqueEntradaProduto->valor) * 100 }}">
                        </div>
                        @if ($errors->has('valor'))
