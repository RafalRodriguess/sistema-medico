...
@if ( \Carbon\Carbon::parse($agendamento['data']) >= Carbon\Carbon::createFromFormat('d/m/Y', $data)->setTimeFromTimeString($agendaDados[$x]['hora_fim']) )
    <div class="agenda_horario_row row">
        <div class="agenda_horario " >
            <strong sty>-</strong>
        </div>
        <div class="agenda_eventos row col-md ">
            
            <div class="agenda_eventos col-md-11 p-0 agenda_eventos_row_horario @if ($agendamento['id_referente'] != null) horario_cancelado_nao_exibir @endif">
                    ...
                    <div class="agendamento_col agendamento-procedimentos">
                        ...
                        @if($agendamento->agendamentoProcedimento->count() > 0)
                            ...
                            <span data-toggle="tooltip" title="" data-original-title="Convênio: {{$agendamento->agendamentoProcedimento[0]->procedimentoInstituicaoConvenio->convenios->nome}}" style="font-weight:bold;">
                                {{strtoupper(mb_substr($agendamento->agendamentoProcedimento[0]->procedimentoInstituicaoConvenio->convenios->nome, 0, 20))}} @if(strlen($agendamento->agendamentoProcedimento[0]->procedimentoInstituicaoConvenio->convenios->nome > 20)) ... @endif
                            </span>
                            <span style="font-weight:bold;">-</span>
                            ...
                            {{mb_substr(strtoupper($agendamento->agendamentoProcedimento[0]->procedimentoInstituicaoConvenio->procedimentoInstituicao->procedimento->descricao), 0, 20)}} @if(strlen($agendamento->agendamentoProcedimento[0]->procedimentoInstituicaoConvenio->convenios->nome > 20)) ... @endif
                            </span>
