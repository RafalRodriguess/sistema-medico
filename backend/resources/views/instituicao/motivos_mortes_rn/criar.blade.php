...
@section('conteudo')
    ...
    @component('components/page-title', [
        'titulo' => 'Cadastrar Motivos de morte de recem nascido',
        'breadcrumb' => [
            'Motivos de morte de recem nascido' => route('instituicao.motivosMortesRN.index'),
            'Novo',
        ],
    ])
    @endcomponent
    ...
    <div class="card">
        <div class="card-body ">
            <form action="{{ route('instituicao.motivosMortesRN.store') }}" method="post">
                @csrf
