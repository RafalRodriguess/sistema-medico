...
@section('conteudo')
    ...
    @component('components/page-title', [
        'titulo' => "Editar Setor #{$setore->id} {$setore->nome}Cadastrar Setores",
        'breadcrumb' => [
    ...
    <div class="card">
        <div class="card-body ">
            <form action="{{ route('instituicao.tipoPartos.update', [$setore]) }}" method="post">
                @method('put')
                @csrf
                ...
                <div class="row">
                    <div class=" col-md-8 form-group @if($errors->has('descricao')) has-danger @endif">
                        ...
                        <input type="text" name="descricao" value="{{ old('descricao', $setore->descricao) }}"
                    ...
                    <div class=" col-md-4 form-group @if($errors->has('motivo')) has-danger @endif">
                        ...
                        <select class="form-control @if($errors->has('motivo')) form-control-danger @endif" name="motivo" id="motivo" required>
                            <option value="0" {{(old('motivo', $setore->motivo == 0)) ? "selected" : ""}}>Não</option>
                            <option value="1" {{(old('motivo', $setore->motivo == 1)) ? "selected"  : ""}}>Sim</option>
                        </select>
