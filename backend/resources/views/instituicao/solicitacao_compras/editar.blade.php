...
@section('conteudo')
    @component('components/page-title', [
        'titulo' => "Editar Solicitação de Compras #{$solicitacao_compras->id} {$solicitacao_compras->atendimento}",
        'breadcrumb' => [
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('instituicao.solicitacaoCompras.update', $solicitacao_compras,1) }}" method="post">
                @method('put')
                @csrf
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="form-group @if($errors->has('data_solicitacao')) has-danger @endif">
                            ...
                            <input type="text" name="data_solicitacao" alt="date"  value="{{ !empty($solicitacao_compras->data_solicitacao) ? date('d/m/Y', strtotime($solicitacao_compras->data_solicitacao)) : null }}"
                    ...
                    <div class="col-sm-2">
                        <div class="form-group @if($errors->has('data_maxima')) has-danger @endif">
                            ...
                            <input type="text" name="data_maxima" alt="date"  value="{{ !empty($solicitacao_compras->data_maxima) ? date('d/m/Y', strtotime($solicitacao_compras->data_maxima)) : null }}"
                     ...
                     <div class="col-sm-2">
                        <div class="form-group @if($errors->has('data_impressao')) has-danger @endif">
                            ...
                            <input type="text" name="data_impressao" alt="date"  value="{{  !empty($solicitacao_compras->data_impressao) ? date('d/m/Y', strtotime($solicitacao_compras->data_impressao)) : null }}"
                    ...
                    <div class="col-md-6 form-group @error('setores_exames_id') has-danger @enderror">
                        <label class="form-control-label">Setor  <span class="text-danger">*</span></label>
                        <select required id='setores_exames_id' name="setores_exames_id"
                            class="form-control select2 @error('setores_exames_id') form-control-danger @enderror" style="width: 100%">
                            <option value="">Selecione</option>
                            @foreach ($setores as $setor)
                                <option value="{{$setor->id}}" @if (old('setores_exames_id', $solicitacao_compras->setores_exames_id) == $setor->id) selected="selected" @endif>{{$setor->descricao}}</option>
                            @endforeach
                        </select>
                        @error('setores_exames_id')
                   ...
                   {{-- 
                    <div class="col-sm-2">
                        <div class="form-group @if($errors->has('cod_usuario')) has-danger @endif">
                            ...
                            <input type="text" name="cod_usuario" value="{{ $solicitacao_compras->cod_usuario }}"
                                class="form-control  @if($errors->has('cod_usuario')) form-control-danger @endif">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="form-group @if($errors->has('nome_solicitante')) has-danger @endif">
                            ...
                            <input type="text" name="nome_solicitante" value="{{ old('nome_solicitante',$solicitacao_compras->nome_solicitante) }}"
                            class="form-control  @if($errors->has('nome_solicitante')) form-control-danger @endif">
                    ...
                    <div class="col-md-2 form-group @error('motivo_pedido_id') has-danger @enderror">
                        <label class="form-control-label">Motivo do Pedido <span class="text-danger">*</span></label>
                        <select required id='motivo_pedido_id' name="motivo_pedido_id" style="width: 100%"
                            class="form-control select2 @error('motivo_pedido_id') form-control-danger @enderror">
                            <option value="">Selecione</option>
                            @foreach ($motivoPedidos as $motivoPedido)
                                <option value="{{$motivoPedido->id}}" @if (old('motivo_pedido_id', $solicitacao_compras->motivo_pedido_id) == $motivoPedido->id) selected="selected" @endif>{{$motivoPedido->descricao}}</option>
                            @endforeach
                        </select>
                        @error('motivo_pedido_id')
                            <div class="form-control-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    
                    <div class="col-md-3 form-group @error('comprador_id') has-danger @enderror">
                        <label class="form-control-label">Comprador<span class="text-danger">*</span></label>
                        <select required id='comprador_id' name="comprador_id" style="width: 100%"
                            class="form-control select2 @error('comprador_id') form-control-danger @enderror">
                            <option value="">Selecione</option>
                            @foreach ($compradores as $comprador)
                               <option value="{{$comprador->id}}" @if (old('comprador_id', $solicitacao_compras->comprador_id) == $comprador->id) selected="selected" @endif>{{$comprador->descricao}}</option>
                            @endforeach
                        </select>
                        @error('comprador_id')
                            <div class="form-control-feedback">{{ $message }}</div>
                    ...
                    <div class="col-md-5 form-group @error('estoque_id') has-danger @enderror">
                        <label class="form-control-label">Estoque<span class="text-danger">*</span></label>
                        <select required id='estoque_id' name="estoque_id" style="width: 100%"
                            class="form-control select2 @error('estoque_id') form-control-danger @enderror">
                            <option value="">Selecione</option>
                            @foreach ($estoques as $estoque)
                                <option value="{{$estoque->id}}" @if (old('estoque_id', $solicitacao_compras->estoque_id) == $estoque->id) selected="selected" @endif>{{$estoque->descricao}}</option>
                            @endforeach
                        </select>
                        @error('estoque_id')
                            <div class="form-control-feedback">{{ $message }}</div>
                    ...
                    <div class="col-sm-2">
                        <div class="form-group @if($errors->has('sol_agrup')) has-danger @endif">
                            ...
                            <input type="text" name="sol_agrup" value="{{ old('sol_agrup', $solicitacao_compras->sol_agrup) }}"
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="form-group num_parcelas">
                            ...
                            <div class="demo-radio-button">
                                <input name="servico_produto" type="radio" id="radio_1" value="1" @if ($solicitacao_compras->servico_produto == 1)
                                    checked
                                @endif />
                                <label for="radio_1">Serviço</label>
                                <input name="servico_produto" type="radio" id="radio_2" value="2" @if ($solicitacao_compras->servico_produto == 2)
                                    checked 
                                @endif/>
                     ...
                     <div class="form-group col-md-1" style="margin-top: 33px;">
                        <input type="checkbox" id="urgente" name="urgente" class="filled-in chk-col-teal" @if ($solicitacao_compras->urgente == 1)
                        checked
                        @endif value="1"/>
                    ...
                    <div class="col-sm-1 form-group">
                        ...
                        <select class="form-control" name="solicitacao_opme">
                            <option value="1" @if ($solicitacao_compras->solicitacao_opme == 1)  selected="selected" @endif>Sim</option>
                            <option value="0" @if ($solicitacao_compras->solicitacao_opme == 0)  selected="selected" @endif>Não</option>
                        </select>
                    </div>
                    {{--  
                    <div class="col-sm-2">
                        <div class="form-group @if($errors->has('atendimento')) has-danger @endif">
                            ...
                            <input type="text" name="atendimento" value="{{ old('atendimento', $solicitacao_compras->atendimento) }}"
                    ...
                    <div class="col-sm-2">
                        <div class="form-group @if($errors->has('pre_int')) has-danger @endif">
                            ...
                            <input type="text" name="pre_int" value="{{ old('pre_int', $solicitacao_compras->pre_int) }}"
                    ...
                    <div class="col-sm-2">
                        <div class="form-group @if($errors->has('av_cirurgia')) has-danger @endif">
                            ...
                            <input type="text" name="av_cirurgia" value="{{ old('av_cirurgia', $solicitacao_compras->av_cirurgia) }}"
                    ...
                    <div class="col-sm-2">
                        <div class="form-group @if($errors->has('data_maxima_apoio_cotacao')) has-danger @endif">
                            ...
                            <input type="text" name="data_maxima_apoio_cotacao" id="data_maxima_apoio_cotacao" alt="date" value="{{ !empty($solicitacao_compras->data_maxima_apoio_cotacao) ? date('d/m/Y', strtotime($solicitacao_compras->data_maxima_apoio_cotacao)) : null }}"
