@php($oldCc = old('cc') ?: [])
@if (empty($oldCc))
    @if ($planoConta->centroCusto)
        @for ($i = 0; $i < count($planoConta->centroCusto); $i++)
            <div class="col-md-12 item-cc">
                <div class="row">
                    ...
                    <div class="form-group dados_parcela col-md-8 @if($errors->has("cc.{$i}.centro_custos_id")) has-danger @endif">
                        ...
                        <select name="cc[{{$i}}][centro_custos_id]" class="form-control selectfild2 @if($errors->has("cc.{$i}.centro_custos_id")) form-control-danger @endif" style="width: 100%">
                            ...
                            @foreach ($centroCusto as $item)
                                <option value="{{$item->id}}" @if (old("cc.{$i}.centro_custos_id", $planoConta->centroCusto[$i]->id) == $item->id)
                                    selected="selected"
                    ...
                    <div class="form-group col-md-4 @if($errors->has("cc.{$i}.percentual")) has-danger @endif">
                        ...
                        <input type="text" alt="decimal" class="form-control percentual_cc @if($errors->has("cc.{$i}.percentual")) form-control-danger @endif" name="cc[{{$i}}][percentual]" id="cc[{{$i}}][percentual]" value="{{old("cc.{$i}.percentual", $planoConta->centroCusto[$i]->pivot->percentual)}}" onchange="totalCC(this)">
    ...
    @else
        <div class="col-md-12 item-cc">
            <div class="row">
                ...
                <div class="form-group dados_parcela col-md-8 @if($errors->has("cc.0.centro_custos_id")) has-danger @endif">
                    <label class="form-control-label">Centro de custo:</span></label>
