...
@section('conteudo')
    ...
    <div class="card">
        <div class="card-body ">
            <form action="{{ route('instituicao.triagem.filas.store') }}" method="post">
                @csrf
                    ...
                    <div class="col-md-2 col-sm-3 form-group @if ($errors->has('identificador')) has-danger @endif">
                        ...
                        <select name="identificador" id="select-identificadores"
                            ...
                            @foreach ($identificadores as $identificador)
                                <option @if (old('identificador') == $identificador) selected="selected" @endif value="{{ $identificador }}">{{ $identificador }}</option>
                            @endforeach
                        </select>
                ...
                <div class="row">
                    <div class="col-md-6 form-group @if ($errors->has('origens_id')) has-danger @endif">
                        ...
                        <select name="origens_id" id="select-origem"
                            ...
                            @foreach ($origens as $origem)
                                <option @if (old('origens_id') == $origem->id) selected="selected" @endif value="{{ $origem->id }}">{{ $origem->descricao }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="px-3 form-group  d-flex align-items-end pb-2 @if ($errors->has('ativo')) has-danger @endif">
                        <div class="d-flex align-items-baseline">
                            <input type="checkbox" name="ativo" id="check-ativo" @if(!empty(old('ativo'))) checked="checked" @endif>
                    ...
                    <div class="px-3 form-group  d-flex align-items-end pb-2 @if ($errors->has('prioridade')) has-danger @endif">
                        <div class="d-flex align-items-baseline">
                            <input type="checkbox" name="prioridade" id="check-prioridade" @if(!empty(old('prioridade'))) checked="checked" @endif>
...
@push('scripts')
    ...
    {{-- Coloque $ onde deve ser substituido pelo id do processo --}}
