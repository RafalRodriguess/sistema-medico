...
@section('conteudo')
    ...
    <div class='row page-titles'>
            <div class='col-md-5 col-8 align-self-center'>
                <h3 class='text-themecolor m-b-0 m-t-0'>Salas Cirúrgicas</h3>
                <ol class='breadcrumb'>
                    <li class='breadcrumb-item'><a href='{{ route('instituicao.centros.cirurgicos.index') }}'>Centros Cirúrgicos</a></li>
                    <li class='breadcrumb-item active'>
                        Salas do Centro Cirúrgico #{{ $centro_cirurgico->id }}
                    </li>
                </ol>
            </div>
        ...
        <div class='row'>
            <div class='col-12'>
                <!-- Column -->
                <div class='card'>
                    @livewire('instituicao.salas-cirurgicas-pesquisa', ['centro_cirurgico' => $centro_cirurgico])
                </div>
                <!-- Column -->
