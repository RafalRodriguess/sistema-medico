...
@section('conteudo')
    ...
    @component('components/page-title', [
        'titulo' => 'Cadastrar Caixa cirúrgico',
        'breadcrumb' => [
    ...
    <div class="card">
        <div class="card-body ">
            <form action="{{ route('instituicao.caixasCirurgicos.store') }}" method="post">
                @csrf
                <div class="row">
                    ...
                    <div class="form-group col-md-3" style="margin-top: 25px;">
                        <input type="checkbox" id="ativo" name="ativo" class="filled-in form-control" @if (old('ativo') == 1)
                        checked
                    @endif/>
