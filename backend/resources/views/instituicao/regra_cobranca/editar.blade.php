@extends('instituicao.layout')
    ...
    @component('components/page-title', [
        'titulo' => "Editar Regra de Cobrança #{$regra->id} {$regra->descricao}",
        'breadcrumb' => [
    ...
    <div class="card">
        <div class="card-body ">
            <form action="{{ route('instituicao.regrasCobranca.update', [$regra]) }}" method="post">
                @method('put')
                @csrf
                ...
                <div class="row">
                    <div class=" col-md-12 form-group @if($errors->has('descricao')) has-danger @endif">
                        ...
                        <input type="text" name="descricao" value="{{ old('descricao', $regra->descricao) }}"
                    ...
                    <div class=" col-md-4 form-group @if($errors->has('cir_mesma_via')) has-danger @endif">
                        ...
                        <input type="text" alt="porcentagem" name="cir_mesma_via" value="{{ old('cir_mesma_via', $regra->cir_mesma_via) }}"
                    ...
                    <div class=" col-md-4 form-group @if($errors->has('cir_via_diferente')) has-danger @endif">
                        ...
                        <input type="text" alt="porcentagem" name="cir_via_diferente" value="{{ old('cir_via_diferente', $regra->cir_via_diferente) }}"
                    ...
                    <div class=" col-md-4 form-group @if($errors->has('base_via_acesso')) has-danger @endif">
                        ...
                        <select class="form-control select2 @if($errors->has('base_via_acesso')) form-control-danger @endif" name="base_via_acesso" id="base_via_acesso" style="width: 100%">
                            <option value="cirurgia" @if (old('base_via_acesso', $regra->base_via_acesso) == "cirurgia")
                                selected
                            @endif>Cirurgia</option>
                            <option value="prestador" @if (old('base_via_acesso', $regra->base_via_acesso) == "prestador")
                                selected
                    ...
                    <div class="col-md-2">
                        <input type="checkbox" id="horario_especial" name="horario_especial" value="1" @if (old("horario_especial", $regra->horario_especial)) checked @endif class="filled-in chk-col-teal"/>
                    ...
                    <div class="col-md-2">
                        <input type="checkbox" id="internacao" name="internacao" value="1" @if (old("internacao", $regra->internacao)) checked @endif class="filled-in chk-col-teal"/>
                    ...
                    <div class="col-md-2">
                        <input type="checkbox" id="ambulatorial" name="ambulatorial" value="1" @if (old("ambulatorial", $regra->ambulatorial)) checked @endif class="filled-in chk-col-teal"/>
                    ...
                    <div class="col-md-2">
                        <input type="checkbox" id="urgencia_emergencia" name="urgencia_emergencia" value="1" @if (old("urgencia_emergencia", $regra->urgencia_emergencia)) checked @endif class="filled-in chk-col-teal"/>
                    ...
                    <div class="col-md-2">
                        <input type="checkbox" id="externo" name="externo" value="1" @if (old("externo", $regra->externo)) checked @endif class="filled-in chk-col-teal"/>
                    ...
                    <div class="col-md-2">
                        <input type="checkbox" id="home_care" name="home_care" value="1" @if (old("home_care", $regra->home_care)) checked @endif class="filled-in chk-col-teal"/>
