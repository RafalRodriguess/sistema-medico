...
@section('conteudo')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Registro de Log</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Relatório</a></li>
                <li class="breadcrumb-item active">Registro de Log</li>
            </ol>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="javascript:void(0)" class="formRelatorioRegistroLog" id="formRelatorioRegistroLog">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" style="width: 100%" name="tipo" id="tipo" required>
                                        <option value="" selected>Selecione</option>
                                        @foreach ($tipo as $key => $item)
                                            <option value="{{$key}}">{{$item}}</option>
                                        @endforeach
                                    </select>
                                    {{-- <span style="cursor: pointer" onclick="limpa_filtros('tipo')" class="help" data-toggle="tooltip" data-placement="top" data-original-title="Limpar filtros"><i class="fa fa-trash"></i> </span>
                                    <span style="cursor: pointer" onclick="seleciona_filtros('tipo')" class="help" data-toggle="tooltip" data-placement="top" data-original-title="Selecionar todos os filtros"><i class="fa fa-reply-all"></i> </span> --}}
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="registro_id" name="registro_id" class="form-control" >
                                </div>
                            </div>
                    ...
                    <div class="table-responsive print-table mb-2">
                        <div class="cabecalho" style="display: none;">
                            ...
                            <h3 class="mt-3"><center>Relatório de registro de log <span class='texto_titulo'></span></center></h3>
...
@push('scripts')
    <script>
        ...
        $('#formRelatorioRegistroLog').on('submit', function(e){
            e.preventDefault()
            var formData = new FormData($(this)[0]);
            $.ajax("{{route('instituicao.relatorioRegistroLog.tabela')}}", {
                method: "POST",
                data: formData,
                processData: false,
                contentType: false,
