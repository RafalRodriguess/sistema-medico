...
@push('scripts')
    <script>
        function imprimir(){
            ...
            url = "{{route('instituicao.relatoriosFinanceiros.exportRelatorios', ['relatorio' => 'a_receber', 'tipo' => 'pdf'])}}"+"/?"+formData;
        ...
        function excel(){
            ...
            url = "{{route('instituicao.relatoriosFinanceiros.exportRelatorios', ['relatorio' => 'a_receber', 'tipo' => 'xlsx'])}}"+"/?"+formData;
        ...
        $('#formRelatorio').on('submit', function(e){
            ...
            $.ajax("{{route('instituicao.relatoriosFinanceiros.aReceberTabela')}}", {
                method: "POST",
                data: formData,
                processData: false,
                contentType: false,
