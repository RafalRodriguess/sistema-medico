...
@section('conteudo')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Contas recebidas</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Relatorio</a></li>
                <li class="breadcrumb-item active">Contas recebidas</li>
            </ol>
        </div>
...
@push('scripts')
    <script>
        function imprimir(){
            ...
            url = "{{route('instituicao.relatoriosFinanceiros.exportRelatorios', ['relatorio' => 'recebidas', 'tipo' => 'pdf'])}}"+"/?"+formData;
        ...
        function excel(){
            ...
            url = "{{route('instituicao.relatoriosFinanceiros.exportRelatorios', ['relatorio' => 'recebidas', 'tipo' => 'xlsx'])}}"+"/?"+formData;
        ...
        $('#formRelatorio').on('submit', function(e){
            ...
            $.ajax("{{route('instituicao.relatoriosFinanceiros.recebidasTabela')}}", {
                method: "POST",
                data: formData,
                processData: false,
                contentType: false,
