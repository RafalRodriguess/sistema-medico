...
@push('scripts')
    <script>
        function imprimir(){
            ...
            url = "{{route('instituicao.relatoriosFinanceiros.exportRelatorios', ['relatorio' => 'a_pagar', 'tipo' => 'pdf'])}}"+"/?"+formData;
        ...
        function excel(){
            ...
            url = "{{route('instituicao.relatoriosFinanceiros.exportRelatorios', ['relatorio' => 'a_pagar', 'tipo' => 'xlsx'])}}"+"/?"+formData;
        ...
        $('#formRelatorio').on('submit', function(e){
            ...
            $.ajax("{{route('instituicao.relatoriosFinanceiros.aPagarTabela')}}", {
                method: "POST",
                data: formData,
                processData: false,
                contentType: false,
