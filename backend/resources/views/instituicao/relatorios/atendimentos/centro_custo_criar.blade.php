    ...
    <div class="col-md-12 item-cc">
        <div class="row">
            ...
            <div class="form-group col-md-4 @if($errors->has("cc.0.valor")) has-danger @endif">
                ...
                <input type="text" alt="decimal" class="form-control set-mask valor_cc @if($errors->has("cc.0.valor")) form-control-danger @endif" name="cc[0][valor]" id="cc[0][valor]" value="{{old("cc.0.valor")}}" onchange="totalCC(this)">
        ...
        <div class="col-md-12 item-cc">
            <div class="row">
                ...
                <div class="form-group col-md-4 @if($errors->has("cc.{$i}.valor")) has-danger @endif">
                    <label class="form-control-label">Valor *</span></label>
                    <input type="text" alt="decimal" class="form-control set-mask valor_cc @if($errors->has("cc.{$i}.valor")) form-control-danger @endif" name="cc[{{$i}}][valor]" id="cc[{{$i}}][valor]" value="{{old("cc.{$i}.valor")}}" onchange="totalCC(this)">
