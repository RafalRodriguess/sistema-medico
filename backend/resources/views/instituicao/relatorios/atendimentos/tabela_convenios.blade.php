            ...
            @foreach($agendamentos as $item)
                ...
                @foreach ($item->agendamentoProcedimento as $procedimento)    
                    ...
                    @php
                        ...
                        if(!empty($procedimentos_array[$convenio_nome.'_'.$proc_nome])){
                            $procedimentos_array[$convenio_nome.'_'.$proc_nome] = array(
                                'proc' => $proc_nome,
                                "valor" => $procedimentos_array[$convenio_nome.'_'.$proc_nome]["valor"] + $procedimento->valor_atual,
                                "qtd" => $procedimentos_array[$convenio_nome.'_'.$proc_nome]["qtd"] + 1  
                            );
                        }else{
                            $procedimentos_array[$convenio_nome.'_'.$proc_nome] = array(
                                'proc' => $proc_nome,
