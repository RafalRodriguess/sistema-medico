...
@section('conteudo')
    ...
    @component('components/page-title', [
        'titulo' => 'Editar Motivo de Conclusão',
        'breadcrumb' => [
    ...
    <div class="card">
        <div class="card-body ">
            <form action="{{ route('instituicao.motivoConclusao.update', [$motivo]) }}" method="post">
                @csrf
                @method('put')
               <div class="row">
                    <div class=" col-md-12 form-group @if($errors->has('descricao')) has-danger @endif">
                        ...
                        <input type="text" name="descricao" required value="{{ old('descricao', $motivo->descricao) }}"
