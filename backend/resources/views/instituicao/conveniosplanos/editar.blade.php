...
@section('conteudo')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('instituicao.convenios.planos.update', [$convenio, $plano]) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="row">
                    ...
                    <div class="col-md-8 form-group @if($errors->has('nome')) has-danger @endif">
                        ...
                        <input type="text" name="nome" value="{{ old('nome', $plano->nome) }}"
                    ...
                    <div class="col-md-4 col-sm-6 form-group d-flex flex-column justify-content-end @if($errors->has('paga_acompanhante')) has-danger @endif">
                        <div class="d-flex flex-wrap-revert align-items-center">
                            <input type="checkbox" name="paga_acompanhante" @if(old('paga_acompanhante', $plano->paga_acompanhante)) checked="checked" @endif"
                    ...
                    <div class="col-md-4 col-sm-6 form-group d-flex flex-column justify-content-end @if($errors->has('validade_indeterminada')) has-danger @endif">
                        <div class="d-flex flex-wrap-revert align-items-center">
                            <input type="checkbox" name="validade_indeterminada" @if(old('validade_indeterminada', $plano->validade_indeterminada)) checked="checked" @endif"
                ...
                <div class="row">
                    <div class="col-md-8 form-group @if($errors->has('descricao')) has-danger @endif">
                        ...
                        <textarea type="text" name="descricao" rows="4"
                            class="form-control @if($errors->has('descricao')) form-control-danger @endif">{{ old('descricao', $plano->descricao) }}</textarea>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 form-group @if($errors->has('senha_guia_obrigatoria')) has-danger @endif">
                        ...
                        <select name="senha_guia_obrigatoria"
                            ...
                            <option value="1" @if(old('senha_guia_obrigatoria', $plano->senha_guia_obrigatoria) == true) selected="selected" @endif>Sim</option>
                            <option value="0" @if(old('senha_guia_obrigatoria', $plano->senha_guia_obrigatoria) == false) selected="selected" @endif>Não</option>
                        </select>
                    ...
                    <div class="col-md-4 col-sm-6 form-group @if($errors->has('valida_guia')) has-danger @endif">
                        ...
                        <select name="valida_guia"
                            ...
                            <option value="1" @if(old('valida_guia', $plano->valida_guia) == true) selected="selected" @endif>Sim</option>
                            <option value="0" @if(old('valida_guia', $plano->valida_guia) == false) selected="selected" @endif>Não</option>
                        </select>
                    ...
                    <div class="col-md-4 col-sm-6 form-group @if($errors->has('regra_cobranca_id')) has-danger @endif">
                        ...
                        <select name="regra_cobranca_id"
                            class="form-control select2 @if($errors->has('regra_cobranca_id')) form-control-danger @endif">
                            <option value="">Selecione...</option>
                            @foreach ($regrasCobranca as $item)
                                <option value="{{$item->id}}" @if(old('regra_cobranca_id', $plano->regra_cobranca_id) == $item->id) selected="selected" @endif>{{$item->descricao}}</option>
                            @endforeach
                        </select>
                        ...
                        <div class="card shadow-none pt-2 px-3">
                            ...
                            <div class="input-group">
                                <div class="pl-0 pr-4 col-md-4 col-sm-6 form-group d-flex flex-column justify-content-end @if($errors->has('permissao_internacao')) has-danger @endif">
                                    <div class="d-flex flex-wrap-revert align-items-center">
                                        <input type="checkbox" name="permissao_internacao" @if(old('permissao_internacao', $plano->permissao_internacao)) checked="checked" @endif"
                                ...
                                <div class="pl-0 pr-4 col-md-4 col-sm-6 form-group d-flex flex-column justify-content-end @if($errors->has('permissao_emergencia')) has-danger @endif">
                                    <div class="d-flex flex-wrap-revert align-items-center">
                                        <input type="checkbox" name="permissao_emergencia" @if(old('permissao_emergencia', $plano->permissao_emergencia)) checked="checked" @endif"
                                ...
                                <div class="pl-0 pr-4 col-md-4 col-sm-6 form-group d-flex flex-column justify-content-end @if($errors->has('permissao_home_care')) has-danger @endif">
                                    <div class="d-flex flex-wrap-revert align-items-center">
                                        <input type="checkbox" name="permissao_home_care" @if(old('permissao_home_care', $plano->permissao_home_care)) checked="checked" @endif"
                                ...
                                <div class="pl-0 pr-4 col-md-4 col-sm-6 form-group d-flex flex-column justify-content-end @if($errors->has('permissao_ambulatorio')) has-danger @endif">
                                    <div class="d-flex flex-wrap-revert align-items-center">
                                        <input type="checkbox" name="permissao_ambulatorio" @if(old('permissao_ambulatorio', $plano->permissao_ambulatorio)) checked="checked" @endif"
                                ...
                                <div class="pl-0 pr-4 col-md-4 col-sm-6 form-group d-flex flex-column justify-content-end @if($errors->has('permissao_externo')) has-danger @endif">
                                    <div class="d-flex flex-wrap-revert align-items-center">
                                        <input type="checkbox" name="permissao_externo" @if(old('permissao_externo', $plano->permissao_externo)) checked="checked" @endif"
