...
@section('conteudo')
    @component('components/page-title', [
        'titulo' => 'Cadastrar Pre Internação',
        'breadcrumb' => [
    ...
    <div class="card col-sm-12">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('instituicao.preInternacoes.store') }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-md-8 form-group @if($errors->has('paciente_id')) has-danger @endif">
                        ...
                        <select class="form-control col-md-11" name="paciente_id" id="paciente_id">
                            @if(old('paciente_id'))
                        ...
                        @endif
                        <input type="hidden" name='paciente_nome' value="{{old('paciente_nome')}}">
                    </div>

                    <div class="col-md-3 form-group @if($errors->has('previsao')) has-danger @endif">
                        <label class="form-control-label p-0 m-0">Previsao</label>
                        <input type="datetime-local" class="form-control p-0 m-0" value="{{ old('previsao') }}"
                            name="previsao" id="previsao" >
                ...
                {{-- <div class='row'>
                    <div class="col-md-1 form-group @if($errors->has('sexo')) has-danger @endif">
                        <label class="form-control-label p-0 m-0">Sexo</label>
                        <input type="text" class="form-control p-0 m-0" value="" name="sexo" id="sexo">
                        @if($errors->has('sexo'))
                            <small class="form-control-feedback">{{ $errors->first('sexo') }}</small>
                        @endif
                    </div>

                    <div class="col-md form-group @if($errors->has('telefone1')) has-danger @endif">
                        <label class="form-control-label p-0 m-0">Telefone 1</label>
                        <input type="text" class="form-control p-0 m-0 telefone" value="" name="telefone1" id="telefone1">
                        @if($errors->has('telefone1'))
                            <small class="form-control-feedback">{{ $errors->first('telefone1') }}</small>
                        @endif
                    </div>

                    <div class="col-md form-group @if($errors->has('telefone2')) has-danger @endif">
                        <label class="form-control-label p-0 m-0">Telefone 2</label>
                        <input type="text" class="form-control p-0 m-0 telefone" value="" name="telefone2" id="telefone2">
                        @if($errors->has('telefone2'))
                            <small class="form-control-feedback">{{ $errors->first('telefone2') }}</small>
                        @endif
                    </div>

                    <div class="col-md form-group @if($errors->has('cidade')) has-danger @endif">
                        <label class="form-control-label p-0 m-0">Cidade</label>
                        <input type="text" class="form-control p-0 m-0" value="" name="cidade" id="cidade">
                        @if($errors->has('cidade'))
                            <small class="form-control-feedback">{{ $errors->first('cidade') }}</small>
                        @endif
                    </div>

                    <div class="col-md form-group @if($errors->has('estado')) has-danger @endif">
                        <label class="form-control-label p-0 m-0">Estado</label>
                        <input type="text" class="form-control p-0 m-0" value="" name="estado" id="estado">
                        @if($errors->has('estado'))
                            <small class="form-control-feedback">{{ $errors->first('estado') }}</small>
                        @endif
                    </div>
                </div> --}}
                ...
                <div class='row'>
                    ...
                    <div class="col-md form-group @if($errors->has('cid_id')) has-danger @endif">
                        <label class="form-control-label p-0 m-0">Cid <span class="text-danger">*</span></label>
                ...
                <div class='responsavel'>
                    ...
                    <div class='row'>
                        ...
                        <div class="col-md form-group @if($errors->has('telefone1_responsavel')) has-danger @endif">
                            ...
                            <input type="text" class="form-control p-0 m-0 telefone" value="{{ old('telefone1_responsavel') }}"
                        ...
                        <div class="col-md form-group @if($errors->has('telefone2_responsavel')) has-danger @endif">
                            <label class="form-control-label p-0 m-0">Telefone 2</label>
                            <input type="text" class="form-control p-0 m-0 telefone" value="{{ old('telefone2_responsavel') }}"
...
@push('scripts')
    <script>
        ...
        //         $.ajax({
        //             url: "{{route('instituicao.PreInternacoes.getEspecialidades')}}",
        //             type: 'post',
        //             data: {
        //                 "_token": "{{ csrf_token() }}",
        //                 medico_id: id
        ...
        //                    $('#especialidade_id').append("<option {{ (old('especialidade_id') == "+ retorno[i]['id'] +") ? 'selected' : '' }} value = "+ retorno[i]['id'] +" >" + retorno[i]['descricao'] + "</option>");
        //                 }
