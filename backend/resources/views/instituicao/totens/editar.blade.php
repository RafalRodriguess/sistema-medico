...
@section('conteudo')
    ...
    @component('components/page-title', [
        'titulo' => "Editar Totem {$totem->nome}",
        'breadcrumb' => [
    ...
    <div class="card">
        <div class="card-body ">
            <form action="{{ route('instituicao.triagem.totens.update', [$totem]) }}" method="post">
                @method('put')
                @csrf
                ...
                <div class="row">
                    ...
                    <div class=" col-md-8 form-group @if($errors->has('descricao')) has-danger @endif">
                        ...
                        <input type="text" name="descricao" value="{{ old('descricao', $totem->descricao) }}"
                    ...
                    <div class=" col-md-5 form-group">
                        ...
                        <table class="table table-bordered" style="overflow-y: scroll">
                            <tbody id="filas-escolhidas-container">
                                @foreach ($filas_selecionadas as $escolhida)
                                    <tr class="fila-escolhida-input">
                                        <input name="filas[][filas_triagem_id]" type="hidden" class="value-input" value="{{ $escolhida->id }}">
                                        <td class="col-2"><input type="checkbox" class="mx-auto my-0"></td>
                                        <td class="text">{{ $escolhida->descricao }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
