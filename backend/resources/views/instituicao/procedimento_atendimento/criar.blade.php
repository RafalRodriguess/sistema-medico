...
@component('components/page-title', [
    ...
    <div class="card">
        <div class="card-body ">
            <form action="{{ route('instituicao.procedimentoAtendimentos.store') }}" method="post">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-3 form-group @error('tipo_atendimento') has-danger @enderror">
                        ...
                        <select id='tipo_atendimento' name="tipo_atendimento"
                            ...
                            <option value="">Selecione</option>
                            <option value="urgencia" @if (old('tipo_atendimento') == 'urgencia')
                                selected
                            @endif>Urgência/Emergência</option>
                            <option value="ambulatorio" @if (old('tipo_atendimento') == 'ambulatorio')
                                selected
                            @endif>Ambulatório</option>
                            <option value="internacao" @if (old('tipo_atendimento') == 'internacao')
                                selected
                    ...
                    <div class="col-md-3 form-group @error('origem_id') has-danger @enderror">
                        ...
                        <select id='origem_id' name="origem_id"
                            ...
                            @foreach ($origens as $item)
                                <option value="{{ $item->id }}" @if (old('origem_id') == $item->id)
                                    selected
                                @endif>
                                    {{ $item->descricao }}
                                </option>
                    ...
                    <div class="col-md-3 form-group @error('unidade_internacao_id') has-danger @enderror">
                        ...
                        <select id='unidade_internacao_id' name="unidade_internacao_id"
                            ...
                            @foreach ($internacoes as $item)
                                <option value="{{ $item->id }}" @if (old('unidade_internacao_id') == $item->id)
                                    selected
                                @endif>
                                    {{ $item->nome }}
                                </option>
