...
@section('conteudo')
    ...
    @component('components/page-title', [
        'titulo' => "Editar Sangue e Derivados #{$sangue_derivado->id} {$sangue_derivado->descricao}",
        'breadcrumb' => [
            ...
            <form action="{{ route('instituicao.sanguesDerivados.update', [$sangue_derivado]) }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class=" col-md-12 form-group @if($errors->has('descricao')) has-danger @endif">
                        ...
                        <input type="text" name="descricao" value="{{ old('descricao', $sangue_derivado->descricao) }}"
                    ...
                    <div class=" col-md-2 form-group @if($errors->has('qtd')) has-danger @endif">
                        ...
                        <input type="number" name="qtd" value="{{ old('qtd', $sangue_derivado->qtd) }}"
