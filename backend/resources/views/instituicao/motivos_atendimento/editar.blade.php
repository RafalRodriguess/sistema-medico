...
@section('conteudo')
    ...
    @component('components/page-title', [
        'titulo' => 'Editar Motivo de atendimento',
        'breadcrumb' => [
    ...
    <div class="card">
        <div class="card-body ">
            <form action="{{ route('instituicao.motivos_atendimento.update', [$motivo_atendimento]) }}" method="post">
                @csrf
                @method('put')
                ...
                <div class="row">
                    ...
                    <div wire:ignore class="col-md-12 form-group @if($errors->has('descricao')) has-danger @endif">
                        ...
                        <input type="text" class="form-control" name="descricao" value="{{ old('descricao', $motivo_atendimento->descricao) }}">
