...
@section('conteudo')
    @component('components/page-title', [
        'titulo' => "Editar classificação {$classificacao->descricao}",
        'breadcrumb' => [
    ...
    <div class="card">
        <div class="card-body ">
            <form action="{{ route('instituicao.triagem.classificacoes.update', $classificacao) }}" method="post">
                @method('put')
                @csrf
                ...
                <div class="row">
                    <div class=" col-md-6 form-group @if ($errors->has('descricao')) has-danger @endif">
                        ...
                        <input type="text" name="descricao" value="{{ old('descricao', $classificacao->descricao) }}"
                    ...
                    <div class=" col-md-3 form-group @if ($errors->has('prioridade')) has-danger @endif">
                        ...
                        <input type="number" min="0" max="100" step="1" name="prioridade" id="prioridade"
                            value="{{ old('prioridade', $classificacao->prioridade) }}"
                            class="form-control @if ($errors->has('prioridade')) form-control-danger @endif">
                        <small>Um valor entre 0 e 100, onde <b>0 representa menor prioridade</b> e <b>100 prioridade
                                máxima</b>.</small>
                    ...
                    <div class=" col-md-3 form-group @if ($errors->has('cor')) has-danger @endif">
                        ...
                        <div class="col-md-2 col-4 p-0">
                            <input type="color" name="cor" value="{{ old('cor', $classificacao->cor) }}"
