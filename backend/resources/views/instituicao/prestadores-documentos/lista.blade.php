                ...
                <div class="row page-titles">
                    <div class="col-md-12 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Documentos do prestador #{{ $prestador->id }} {{ $prestador->nome }}</li>
                        </ol>
                    </div>
                </div>
                    <!-- ============================================================== -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <!-- Column -->
                            <div class="card">
                                @livewire('instituicao.prestadores-documentos.prestadores-documentos-pesquisa', ['prestador' => $prestador])
                            </div>
                            <!-- Column -->
