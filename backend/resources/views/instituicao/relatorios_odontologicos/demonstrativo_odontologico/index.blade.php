    ...
    <style>
        ...
        @media print {
           * {
            ...
            .formRelatorioDemonstrativoOdontologico{
                display: none;
            }
...
@section('conteudo')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Demonstrativo Odontológico</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Relatório</a></li>
                <li class="breadcrumb-item active">Demonstrativo Odontológico</li>
            </ol>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="javascript:void(0)" class="formRelatorioDemonstrativoOdontologico" id="formRelatorioDemonstrativoOdontologico">
                        @csrf
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="data_inicio" name="data_inicio" class="form-control" value="{{date('Y-m-d')}}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Data final</label>
                                            <input type="date" id="data_fim" name="data_fim" class="form-control" value="{{date('Y-m-d')}}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div style="margin-top: 5px;">
                                        ...
                                        @can('habilidade_instituicao_sessao', 'visualizar_contas_pagar_relatorio_demonstrativo_odontologico')
                                            <input type="checkbox" id="mostrar_conta_pagar" name="mostrar_conta_pagar" class="filled-in" value="1"/>
                                            <label for="mostrar_conta_pagar" style="margin-left: 10px;">Mostrar contas a pagar<label>
                                        @endcan
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" style="width: 100%" name="negociadores[]" id="negociadores" multiple required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" style="width: 100%" name="formas_pagamento[]" id="formas_pagamento" multiple required>
...
@push('scripts')
    <script>
        ...
        $('#formRelatorioDemonstrativoOdontologico').on('submit', function(e){
            e.preventDefault()
            var formData = new FormData($(this)[0]);
            $.ajax("{{route('instituicao.relatorioDemonstrativoOdontologico.tabela')}}", {
                method: "POST",
                data: formData,
                processData: false,
                contentType: false,
