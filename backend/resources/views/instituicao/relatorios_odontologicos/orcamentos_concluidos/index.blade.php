    ...
    <style>
        ...
        @media print {
           * {
            ...
            .formRelatorioOrcamentosConcluidos{
                display: none;
            }
...
@section('conteudo')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Orçamentos Concluídos</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Relatório</a></li>
                <li class="breadcrumb-item active">Orçamentos Concluídos</li>
            </ol>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="javascript:void(0)" class="formRelatorioOrcamentosConcluidos" id="formRelatorioOrcamentosConcluidos">
                        @csrf
                        <div class="row">
...
@push('scripts')
    <script>
        ...
        $('#formRelatorioOrcamentosConcluidos').on('submit', function(e){
            e.preventDefault()
            var formData = new FormData($(this)[0]);
            $.ajax("{{route('instituicao.relatorioOrcamentosConcluidos.tabela')}}", {
                method: "POST",
                data: formData,
                processData: false,
                contentType: false,
