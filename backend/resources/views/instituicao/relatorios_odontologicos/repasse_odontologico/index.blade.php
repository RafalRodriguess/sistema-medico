    ...
    <style>
        ...
        @media print {
           * {
            ...
            .formRelatorioRepasseOdontologico{
                display: none;
            }
...
@section('conteudo')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Repasse Odontológico</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Relatório</a></li>
                <li class="breadcrumb-item active">Repasse Odontológico</li>
            </ol>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="javascript:void(0)" class="formRelatorioRepasseOdontologico" id="formRelatorioRepasseOdontologico">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="form-label">Prestadores</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="form-label">Procedimentos: <span><i class="fa fa-question-circle help" data-toggle="tooltip" data-placement="right" title="" data-original-title="Vazio busca todos os procedimentos"></i></span></label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="form-label">Convenios: 
                                        {{-- <span><i class="fa fa-question-circle help" data-toggle="tooltip" data-placement="right" title="" data-original-title="Vazio busca todos os convenios"></i></span> --}}
                                    </label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="form-label">Forma de pagamento: 
                                        {{-- <span><i class="fa fa-question-circle help" data-toggle="tooltip" data-placement="right" title="" data-original-title="Vazio busca todas as formas de pagamento"></i></span> --}}
                                    </label>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(".select2ProcedimentoPesquisa").select2({
                ...
                ajax: {
                    url:"{{route('instituicao.relatorioRepasseOdontologico.getProcedimentoOdontologicosPesquisa')}}",
                    dataType: 'json',
                    delay: 100,
        ...
        $('#formRelatorioRepasseOdontologico').on('submit', function(e){
            e.preventDefault()
            var formData = new FormData($(this)[0]);
            $.ajax("{{route('instituicao.relatorioRepasseOdontologico.tabela')}}", {
                method: "POST",
                data: formData,
                processData: false,
                contentType: false,
