    ...
    <style>
        ...
        @media print {
           * {
            ...
            .formRelatorioProcedimentosNRealizados{
                display: none;
            }
...
@section('conteudo')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Procedimentos Não Realizados</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Relatório</a></li>
                <li class="breadcrumb-item active">Procedimentos Não Realizados</li>
            </ol>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="javascript:void(0)" class="formRelatorioProcedimentosNRealizados" id="formRelatorioProcedimentosNRealizados">
                        @csrf
                        <div class="row">
...
@push('scripts')
    <script>
        ...
        $('#formRelatorioProcedimentosNRealizados').on('submit', function(e){
            e.preventDefault()
            var formData = new FormData($(this)[0]);
            $.ajax("{{route('instituicao.relatorioProcedimentosNRealizados.tabela')}}", {
                method: "POST",
                data: formData,
                processData: false,
                contentType: false,
