    ...
    <style>
        ...
        @media print {
           * {
            ...
            .formRelatorioOdontologicoGrupo{
                display: none;
            }
...
@section('conteudo')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Demonstrativo Odontológico Grupo</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Relatório</a></li>
                <li class="breadcrumb-item active">Demonstrativo Odontológico Grupo</li>
            </ol>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="javascript:void(0)" class="formRelatorioOdontologicoGrupo" id="formRelatorioOdontologicoGrupo">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" style="width: 100%" name="contas[]" id="contas" multiple>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" style="width: 100%" name="negociadores[]" id="negociadores" multiple>
                                        @foreach ($negociadores as $item)
                                            <option value="{{$item->id}}" selected>{{$item->nome}}</option>
                                        @endforeach
                                    </select>
                                    <span style="cursor: pointer" onclick="limpa_filtros('negociadores')" class="help" data-toggle="tooltip" data-placement="top" data-original-title="Limpar filtros"><i class="fa fa-trash"></i> </span>
                                    <span style="cursor: pointer" onclick="seleciona_filtros('negociadores')" class="help" data-toggle="tooltip" data-placement="top" data-original-title="Selecionar todos os filtros"><i class="fa fa-reply-all"></i> </span>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" style="width: 100%" name="avaliadores" id="avaliadores">
                                        <option value="" selected>Todos</option>
                                        @foreach ($avaliadores as $item)
                                            <option value="{{$item->id}}">{{$item->nome}}</option>
                                        @endforeach
                                    </select>
                                    {{-- <span style="cursor: pointer" onclick="limpa_filtros('avaliadores')" class="help" data-toggle="tooltip" data-placement="top" data-original-title="Limpar filtros"><i class="fa fa-trash"></i> </span>
                                    <span style="cursor: pointer" onclick="seleciona_filtros('avaliadores')" class="help" data-toggle="tooltip" data-placement="top" data-original-title="Selecionar todos os filtros"><i class="fa fa-reply-all"></i> </span> --}}
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="form-label">Formas de Pagamento</label>
                                    <select class="form-control select2" style="width: 100%" name="formas_pagamento[]" id="formas_pagamento" multiple>
                                        @foreach ($formasPagamento as $item)
                                            <option value="{{$item}}" selected>{{App\ContaPagar::forma_pagamento_texto($item)}}</option>
                                        @endforeach
                                    </select>
                                    <span style="cursor: pointer" onclick="limpa_filtros('formas_pagamento')" class="help" data-toggle="tooltip" data-placement="top" data-original-title="Limpar filtros"><i class="fa fa-trash"></i> </span>
                                    <span style="cursor: pointer" onclick="seleciona_filtros('formas_pagamento')" class="help" data-toggle="tooltip" data-placement="top" data-original-title="Selecionar todos os filtros"><i class="fa fa-reply-all"></i> </span>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="form-label">Procedimentos: <span><i class="fa fa-question-circle help" data-toggle="tooltip" data-placement="right" title="" data-original-title="Vazio busca todos os procedimentos, os procedimentos buscados são relacionado aos grupos selecionados"></i></span></label>
                                    <select class="form-control select2ProcedimentoPesquisa" style="width: 100%" name="procedimentos[]" id="procedimentos" multiple>
                    ...
                    <div class="table-responsive print-table mb-2">
                        <div class="cabecalho" style="display: none;">
                            ...
                            <h3 class="mt-3"><center>Relatório de demonstrativo odontológico grupo <span class='texto_titulo'></span></center></h3>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(".select2ProcedimentoPesquisa").select2({
                ...
                ajax: {
                    url:"{{route('instituicao.relatorioOdontologicoGrupo.getProcedimentoOdontologicosPesquisa')}}",
                    dataType: 'json',
                    delay: 100,
        ...
        $('#formRelatorioOdontologicoGrupo').on('submit', function(e){
            e.preventDefault()
            var formData = new FormData($(this)[0]);
            $.ajax("{{route('instituicao.relatorioOdontologicoGrupo.tabela')}}", {
                method: "POST",
                data: formData,
                processData: false,
                contentType: false,
