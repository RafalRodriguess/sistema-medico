...
@section('conteudo')
    ...
    <div class="card">
        <form id="form" action="{{ route('instituicao.convenio.store') }}" method="post" enctype="multipart/form-data">
            @csrf
                ...
                <div class="tab-content card-body bg-white" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-convenio" role="tabpanel"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 form-group @if ($errors->has('apresentacoes_convenio_id')) has-danger @endif">
                                ...
                                <select name="apresentacoes_convenio_id"
                                    ...
                                    @foreach ($apresentacoes as $apresentacao)
                                        <option value="{{ $apresentacao->id }}"
                                            @if (old('apresentacoes_convenio_id') == $apresentacao->id) selected="selected" @endif>
                            ...
                            <div class="col-sm-2 p-4 m-0">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" name="carteirinha_obg" value="1"
                                        @if (old('carteirinha_obg') == '1') checked @endif id="carteirinha_obgCheck">
                            ...
                            <div class="col-sm-2 p-4 m-0">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" name="aut_obrigatoria" value="1"
                                        @if (old('aut_obrigatoria') == '1') checked @endif id="aut_obgCheck">
                                    <label class="form-check-label" for="aut_obgCheck">Autorização obrigatoria?</label>
                                </div>
                            </div>
                            ...
                            @if ($instituicao->possui_convenio_terceiros)    
                                <div class="col-sm-2 p-4 m-0">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" name="possui_terceiros" value="1" @if(old('possui_terceiros')=="1") checked @endif id="possui_terceiros">
                                        <label class="form-check-label" for="possui_terceiros">Convênio integrado com terceiros</label>
                                    </div>
                                </div>
                            @endif
                            
                            <div class=" col-md-4 form-group @if($errors->has('divisao_tipo_guia')) has-danger @endif">
                                ...
                                <select name="divisao_tipo_guia"
                                    ...
                                    <option value="0" @if (old('divisao_tipo_guia') == '0') selected="selected" @endif>
                                        Selecione</option>
                                    <option value="1" @if (old('divisao_tipo_guia') == '1') selected="selected" @endif>
                                        Consulta junto com SADT envio do tipo SADT</option>
                                    <option value="2" @if (old('divisao_tipo_guia') == '2') selected="selected" @endif>
                        ...
                        <div class="row">
                            <div class="col-md-8 col-sm-6 form-group @if ($errors->has('razao_social')) has-danger @endif">
                            ...
                            <div class="col-md-4 col-sm-6 form-group @if ($errors->has('email')) has-danger @endif">
                        ...
                        <div class="row">
                            ...
                            <div
                                ...
                                <input type="text" name="cargo_responsavel" value="{{ old('cargo_responsavel') }}"
                            ...
                            <div
                                ...
                                <input type="email" name="email_glossas" value="{{ old('email_glossas') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group @if ($errors->has('dt_inicio_contrato')) has-danger @endif">
                                ...
                                <input type="date" name="dt_inicio_contrato" value="{{ old('dt_inicio_contrato') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group @if ($errors->has('fone_contato')) has-danger @endif">
                                ...
                                <input type="text" name="fone_contato" value="{{ old('fone_contato') }}"
                                    class="form-control @if ($errors->has('fone_contato')) form-control-danger @endif">
                            ...
                            <div class="col-md-4 form-group @if ($errors->has('cgc')) has-danger @endif">
                                ...
                                <input type="text" name="cgc" value="{{ old('cgc') }}"
                        ...
                        <div class="row">
                            <div
                                ...
                                <select name="tipo_convenio"
                                    ...
                                    @foreach ($opcoes_tipo_convenio as $id => $opcao)
                                        <option value="{{ $id }}"
                                            @if (old('tipo_convenio') == $id) selected="selected" @endif>
                                            {{ $opcao }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div
                                ...
                                <select name="categoria_obrigatoria"
                                    ...
                                    <option selected disabled hidden>Selecione ...</option>
                                    <option value="1" @if (old('categoria_obrigatoria') == 1) selected="selected" @endif>
                                        Sim</option>
                                    <option value="0" @if (old('categoria_obrigatoria') == 0) selected="selected" @endif>
                                        Não</option>
                                </select>
                            ...
                            <div
                                ...
                                <select name="guia_obrigatoria"
                                    ...
                                    @foreach ($opcoes_guia_obrigatoria as $id => $opcao)
                                        <option value="{{ $id }}"
                                            @if (old('guia_obrigatoria') == $id) selected="selected" @endif>
                                            {{ $opcao }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div
                                ...
                                <select name="abate_devolucao"
                                    ...
                                    <option selected disabled hidden>Selecione ...</option>
                                    <option value="1" @if (old('abate_devolucao') == 1) selected="selected" @endif>
                                        Sim</option>
                                    <option value="0" @if (old('abate_devolucao') == 0) selected="selected" @endif>
                                        Não</option>
                                </select>
                            ...
                            <div
                                ...
                                <select name="filantropia"
                                    ...
                                    <option selected disabled hidden>Selecione ...</option>
                                    <option value="1" @if (old('filantropia') == 1) selected="selected" @endif>
                                        Sim</option>
                                    <option value="0" @if (old('filantropia') == 0) selected="selected" @endif>
                                        Não</option>
                                </select>
                            ...
                            <div
                                ...
                                <select name="fatura_p_alta"
                                    ...
                                    <option selected disabled hidden>Selecione ...</option>
                                    <option value="1" @if (old('fatura_p_alta') == 1) selected="selected" @endif>
                                        Sim</option>
                                    <option value="0" @if (old('fatura_p_alta') == 0) selected="selected" @endif>
                                        Não</option>
                                </select>
                            ...
                            <div
                                ...
                                <select name="desc_conta"
                                    ...
                                    <option selected disabled hidden>Selecione ...</option>
                                    <option value="1" @if (old('desc_conta') == 1) selected="selected" @endif>
                                        Sim</option>
                                    <option value="0" @if (old('desc_conta') == 0) selected="selected" @endif>
                                        Não</option>
                                </select>
                                ...
                                <select name="versao_tiss_id"
                                    ...
                                    @foreach ($versoes_tiss as $versao)
                                        <option value="{{ $versao->id }}"
                                            {{ old('versao_tiss_id') == $versao->id ? 'selected="selected"' : '' }}>
                                            {{ $versao->versao }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-2">
                                <div class="form-group {{ $errors->has('imagem') ? 'has-danger' : '' }}">
                                    <label style="cursor: pointer;display:block;" data-toggle="tooltip" title="Foto"
                                        data-original-title="Mude sua logo">
                    ...
                    <div class="tab-pane fade" id="nav-complemento" role="tabpanel"
                        ...
                        <div class="row">
                            ...
                            <div
                                class="col-md-8 col-sm-6 form-group @if ($errors->has('pessoas_id')) has-danger @endif"">
                                <label class="form-control-label">Fornecedor</label>
                                <select name="pessoas_id"
                                    class="select2 form-control @if ($errors->has('pessoas_id')) form-control-danger @endif"
                                    style="width: 100%"
                                    title="Selecione como será a forma de agrupamento dos materiais médicos para o faturamento">
                                    <option selected disabled hidden>Selecione ...</option>
                                    @foreach ($fornecedores as $fornecedor)
                                        <option value="{{ $fornecedor->id }}"
                                            @if (old('pessoas_id') == $fornecedor->id) selected="selected" @endif>
                            ...
                            <div
                                ...
                                <select name="forma_agrupamento"
                                    ...
                                    @foreach ($opcoes_forma_agrupamento as $id => $opcao)
                                        <option value="{{ $id }}"
                                            @if (old('forma_agrupamento') == $id) selected="selected" @endif>
                                            {{ $opcao }}</option>
                                    @endforeach
                                </select>
                                ...
                                <div
                                    ...
                                    <div class="input-group">
                                        <input name="retorno_atendimento_ambulatorio" type="number" min="0"
                                            ...
                                            value="{{ old('retorno_atendimento_ambulatorio') }}">
                                ...
                                <div
                                    ...
                                    <div class="input-group">
                                        <input name="retorno_atendimento_externo" type="number" min="0"
                                            ...
                                            value="{{ old('retorno_atendimento_externo') }}">
                                        <button class="btn btn-secondary ml-1" type="button" data-toggle="modal"
                                ...
                                <div
                                    ...
                                    <div class="input-group">
                                        <input name="retorno_atendimento_urgencia" type="number" min="0"
                                            ...
                                            value="{{ old('retorno_atendimento_urgencia') }}">
                                        <button class="btn btn-secondary ml-1" type="button" data-toggle="modal"
                                ...
                                <div
                                    ...
                                    <div class="d-flex flex-wrap-revert align-items-center">
                                        <input type="checkbox" name="permitir_atendimento_ambulatorial"
                                            @if (old('permitir_atendimento_ambulatorial')) checked="checked" @endif
                                ...
                                <div
                                    ...
                                    <div class="d-flex flex-wrap-revert align-items-center">
                                        <input type="checkbox" name="permitir_atendimento_externo"
                                            @if (old('permitir_atendimento_externo')) checked="checked" @endif
                            ...
                            <div class="col-md-6 form-group @if ($errors->has('fonte_de_remuneracao')) has-danger @endif">
                                ...
                                <select name="fonte_de_remuneracao"
                                    ...
                                    @foreach ($opcoes_fonte_de_remuneracao as $id => $opcao)
                                        <option value="{{ $id }}"
                                            @if (old('fonte_de_remuneracao') == $id) selected="selected" @endif>
                                            {{ $opcao }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div
                                ...
                                <select name="carteira_pede"
                                    ...
                                    <option value="1" @if (old('carteira_pede') == 1) selected="selected" @endif>
                                        Sim</option>
                                    <option value="0" @if (old('carteira_pede') == 0) selected="selected" @endif>
                                        Não</option>
                                </select>
                            ...
                            <div
                                ...
                                <select name="carteira_verif_elig"
                                    ...
                                    <option value="1" @if (old('carteira_verif_elig') == 1) selected="selected" @endif>
                                        Sim</option>
                                    <option value="0" @if (old('carteira_verif_elig') == 0) selected="selected" @endif>
                                        Não</option>
                                </select>
                            ...
                            <div
                                ...
                                <select name="carteira_obg"
                                    ...
                                    <option value="1" @if (old('carteira_obg') == 1) selected="selected" @endif>
                                        Sim</option>
                                    <option value="0" @if (old('carteira_obg') == 0) selected="selected" @endif>
                                        Não</option>
                                </select>
                            ...
                            <div
                                ...
                                <div class="d-flex flex-wrap-revert align-items-center">
                                    ...
                                    <input type="number" name="limite_contas_pre_remessa"
                                        value="{{ old('limite_contas_pre_remessa') }}"
                            ...
                            <div
                                ...
                                <div class="d-flex flex-wrap-revert align-items-center">
                                    ...
                                    <input type="checkbox" name="fechar_conta_amb_sem_impressao"
                                        @if (old('fechar_conta_amb_sem_impressao')) checked="checked" @endif
                                ...
                                <div
                                    ...
                                    <div class="col-3 p-0">
                                        <input type="number" name="quantidade_alerta_faixa"
                                            value="{{ old('quantidade_alerta_faixa') }}"
                                            class="form-control checkbox @if ($errors->has('quantidade_alerta_faixa')) form-control-danger @endif">
                                    </div>
                                ...
                                <div class="col-12 form-group @if ($errors->has('tipo_cobranca_oncologia')) has-danger @endif">
                                    ...
                                    <select name="tipo_cobranca_oncologia"
                                        ...
                                        @foreach ($opcoes_tipo_cobranca_oncologia as $id => $opcao)
                                            <option value="{{ $id }}"
                                                @if (old('tipo_cobranca_oncologia') == $id) selected="selected" @endif>
                                                {{ $opcao }}</option>
                                        @endforeach
                                    </select>
