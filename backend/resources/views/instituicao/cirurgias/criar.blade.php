...
@section('conteudo')
    ...
    @component('components/page-title', [
        'titulo' => 'Cadastrar Cirurgia',
        'breadcrumb' => [
            'Cirurgias' => route('instituicao.cirurgias.index'),
            'Novo',
        ],
    ])
    @endcomponent
    ...
    <div class="card">
        <div class="card-body ">
            ...
            <form action="{{ route('instituicao.cirurgias.store') }}" method="post">
                @csrf
               <div class="row">
                    ...
                    <div class=" col-md form-group @if($errors->has('porte')) has-danger @endif">
                        ...
                        <select class="form-control select2 @if($errors->has('porte')) form-control-danger @endif" name="porte" id="porte">
                            ...
                            @foreach (\App\Cirurgia::opcoes_porte as $item)
                                <option {{(old('porte') == $item) ? 'selected' : '' }} value="{{ $item }}">{{ \App\Cirurgia::getPortes($item) }}</option>
                            @endforeach
                        </select>
                        @if($errors->has('porte'))
                    ...
                    <div class=" col-md-2 form-group @if($errors->has('previsao')) has-danger @endif">
                        ...
                        <input type="text" name="previsao" value="{{ old('previsao') }}"
                ...
                <div class='row'>
                    <div class="shadow-none p-3">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input campo" name="obstetricia" value="1" id="obstetricia">
                    ...
                    <div class="col-md form-group @if($errors->has('tipo_parto_id')) has-danger @endif">
                        ...
                        <select class="obstetrico form-control select2 @if($errors->has('tipo_parto_id')) form-control-danger @endif" name="tipo_parto_id" id="tipo_parto_id">
                            <option value="">Selecione</option>
                            @foreach ($partos as $item)
                                <option {{(old('tipo_parto_id') == $item->id) ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->descricao }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md form-group @if($errors->has('grupo_cirurgia_id')) has-danger @endif">
                        ...
                        <select class="form-control select2 @if($errors->has('grupo_cirurgia_id')) form-control-danger @endif" name="grupo_cirurgia_id" id="grupo_cirurgia_id">
                            <option value="">Selecione</option>
                            @foreach ($gruposCirurgias as $item)
                                <option {{(old('grupo_cirurgia_id') == $item->id) ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->descricao }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md form-group @if($errors->has('via_acesso_id')) has-danger @endif">
                        ...
                        <select class="form-control select2 @if($errors->has('via_acesso_id')) form-control-danger @endif" name="via_acesso_id" id="via_acesso_id">
                            <option value="">Selecione</option>
                            @foreach ($viasAcesso as $item)
                                <option {{(old('via_acesso_id') == $item->id) ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->descricao }}</option>
                            @endforeach
                        </select>
                ...
                <div class='row'>
                    <div class="col-md form-group @if($errors->has('tipo_anestesia_id')) has-danger @endif">
                        ...
                        <select class="form-control select2 @if($errors->has('tipo_anestesia_id')) form-control-danger @endif" name="tipo_anestesia_id" id="tipo_anestesia_id">
                            <option value="">Selecione</option>
                            @foreach ($tipoAnestesias as $item)
                                <option {{(old('tipo_anestesia_id') == $item->id) ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->descricao }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md form-group @if($errors->has('convenio_id')) has-danger @endif">
                        ...
                        <select class="form-control select2 @if($errors->has('convenio_id')) form-control-danger @endif" name="convenio_id" id="convenio_id" onchange="getProcedimentos(this)">
                            ...
                            @foreach ($convenios as $item)
                                <option @if (old("convenio_id") == $item->id)
                                    selected
                    ...
                    <div class="col-md form-group @if($errors->has('procedimento_id')) has-danger @endif">
                        ...
                        <select class="form-control select2 @if($errors->has('procedimento_id')) form-control-danger @endif" name="procedimento_id" id="procedimento_id">
                            ...
                            {{-- @foreach ($procedimentos as $item)
                                <option {{(old('procedimento_id') == $item->id) ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->descricao }}</option>
                            @endforeach --}}
                        </select>
                ...
                <div class='row'>
                    <div class=" col-md form-group @if($errors->has('orientacoes')) has-danger @endif">
                        ...
                        <textarea rows='5' name="orientacoes" class="form-control @if($errors->has('orientacoes')) form-control-danger @endif">{{ old('orientacoes') }}</textarea>
                ...
                <div class='row'>
                    <div class=" col-md form-group @if($errors->has('preparos')) has-danger @endif">
                        ...
                        <textarea rows='5' name="preparos" class="form-control @if($errors->has('preparos')) form-control-danger @endif">{{ old('preparos') }}</textarea>
                ...
                <div class='equipamentos'>
                    <div class="card">
                        ...
                        @include('instituicao.cirurgias.equipamentos_criar')
                ...
                <div class='especialidades'>
                    <div class="card">
                        ...
                        @include('instituicao.cirurgias.especialidades_criar')
                ...
                <div class='equipes'>
                    <div class="card">
                        ...
                        @include('instituicao.cirurgias.equipes_criar')
                ...
                <div class='salas'>
                    <div class="card">
                        ...
                        @include('instituicao.cirurgias.salas_cirurgicas_criar')
...
@push('scripts')
    <script>
        var quantidade_equipamento = 0
        var quantidade_especialidade = 0
        var quantidade_equipe = 0
        var quantidade_sala = 0
