@php($oldEspecialidade = old('especialidades') ?: [])
@if (empty($oldEspecialidade))
...
@else
    ...
    @for($i = 0, $max = count($oldEspecialidade); $i < $max; $i++)
        <div class="col-md-12 item-especialidade">
            <div class="row">
                <div class="col-md-12">
                    <a href="javascrit:void(0)" class="small remove-especialidade">(remover)</a>
    ...
    <script>
        ...
        function addEspecialidade(){
            ...
            $("[name^='especialidades[#]']").each(function(index, element) {
                ...
                $(element).attr('name', name.replace('#',quantidade_especialidade));
            })
        }
        ...
        <div class="col-md-12 item-especialidade">
            <div class="row">
                ...
                <div class="form-group col-md-12">
                    <label class="form-control-label">Especialidade:</label>
                    <select name="especialidades[#][especialidade_id]" class="form-control selectfild2" style="width: 100%">
                        <option value="">Selecione uma especialidade</option>
                        @foreach ($especialidades as $item)
