...
@section('conteudo')
    @component('components/page-title', [
        'titulo' => "Editar Maquina de cartão #{$maquina->id}",
        'breadcrumb' => [
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('instituicao.maquinasCartoes.update', [$maquina]) }}" method="post">
                @method('put')
                @csrf
                ...
                <div class="row">
                    <div class="form-group col-md-8 @if($errors->has('descricao')) has-danger @endif">
                        ...
                        <input type="text" name="descricao" class="form-control" value="{{old('descricao', $maquina->descricao)}}">
                    ...
                    <div class="form-group col-md-4  @if($errors->has('codigo')) has-danger @endif">
                        ...
                        <input type="text" name="codigo" class="form-control" value="{{old('codigo', $maquina->codigo)}}">
                    ...
                    <div class="row col-sm-12">
                        ...
                        <div class='form-group col-md-4'>
                            ...
                            <input class='form-control' alt='money' type='text' value="{{old('taxa_debito', $maquina->taxa_debito)}}" name='taxa_debito'>
                        </div>
                    </div>
                    ...
                    <div class="row col-sm-12">
                        ...
                        <ol class="col-sm-12 ml-3 parcelas">
                            @if(!empty($maquina->taxa_credito))
                                @foreach($maquina->taxa_credito as $taxa)
                                    <li class="form-group col-sm-4">
                                        <label>Parcela</label><br>
                                        <label class='form-control-label'>taxa: *</label>
                                        <input class='form-control taxa' alt='money' type='text' value="{{$taxa}}" name='taxa_credito[]'>
                                    </li>
                                @endforeach
                            @endif
                        </ol>
