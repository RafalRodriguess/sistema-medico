...
@section('conteudo')
    ...
    @component('components/page-title', [
        'titulo' => "Editar Instituição para transferência #{$instituicao_transferencia->id}",
        'breadcrumb' => [
    ...
    <div class="card">
        <div class="card-body ">
            <form action="{{ route('instituicao.internacao.instituicoes-transferencia.update', [$instituicao_transferencia]) }}" method="post">
                @method('put')
                @csrf
                ...
                <div class="row">
                    <div class="col-md-7 form-group @if($errors->has('descricao')) has-danger @endif">
                        ...
                        <input type="text" class="form-control" name="descricao"
                            value="{{ old('descricao', $instituicao_transferencia->descricao) }}">
                    ...
                    <div class="col-md-3 form-group @if($errors->has('cnes')) has-danger @endif">
                        ...
                        <input type="number" class="form-control" name="cnes" value="{{ old('cnes', $instituicao_transferencia->cnes) }}">
                        @if($errors->has('cnes'))
                    ...
                    <div class="col-md-2 form-group @if($errors->has('cep')) has-danger @endif">
                        ...
                        <input type="text" class="form-control" alt="cep" name="cep"
                            value="{{ old('cep', $instituicao_transferencia->cep) }}">
                        @if($errors->has('cep'))
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 form-group @if($errors->has('estado')) has-danger @endif">
                        ...
                        <select id="estados" class="form-control @if($errors->has('estado')) form-control-danger @endif" name="estado">
                    ...
                    <div class="col-md-2 form-group @if($errors->has('cidade')) has-danger @endif">
                        ...
                        <input type="text" class="form-control" name="cidade"
                            value="{{ old('cidade', $instituicao_transferencia->cidade) }}">
                    ...
                    <div class="col-md-2 form-group @if($errors->has('bairro')) has-danger @endif">
                        ...
                        <input type="text" class="form-control" name="bairro"
                            value="{{ old('bairro', $instituicao_transferencia->bairro) }}">
                    ...
                    <div class="col-md-3 form-group @if($errors->has('rua')) has-danger @endif">
                        ...
                        <input type="text" class="form-control" name="rua"
                            value="{{ old('rua', $instituicao_transferencia->rua) }}">
                        @if($errors->has('rua'))
                    ...
                    <div class="col-md-2 form-group @if($errors->has('numero')) has-danger @endif">
                        ...
                        <input type="number" class="form-control" name="numero"
                            value="{{ old('numero', $instituicao_transferencia->numero) }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 form-group @if($errors->has('complemento')) has-danger @endif">
                        ...
                        <input type="text" class="form-control" name="complemento" value="{{ old('complemento', $instituicao_transferencia->complemento) }}">
                    ...
                    <div class="col-md-3 form-group @if($errors->has('telefone')) has-danger @endif">
                        ...
                        <input id="telefone" class="form-control telefone @if($errors->has('telefone')) form-control-danger @endif" name="telefone" value="{{ old('telefone', $instituicao_transferencia->telefone) }}">
                    ...
                    <div class="col-md-3 form-group @if($errors->has('email')) has-danger @endif">
                        ...
                        <input id="email" class="form-control @if($errors->has('email')) form-control-danger @endif" name="email" value="{{ old('email', $instituicao_transferencia->email) }}">
                        @if($errors->has('email'))
...
@push('scripts')
    <script>
        ...
        $(document).ready(function(){
            ...
            let estado = '{{ $instituicao_transferencia->estado }}';
