...
@section('conteudo')
    ...
    @component('components/page-title', [
        'titulo' => 'Cadastrar Motivo de Cancelamento de Alta',
        'breadcrumb' => [
    ...
    <div class="card">
        <div class="card-body ">
            <form action="{{ route('instituicao.internacao.motivos-cancelamento-altas.store') }}" method="post">
                @csrf
                ...
                <div class="row mb-3">
                    <div wire:ignore class="col-md-6 form-group @if($errors->has('descricao_motivo_cancelamento_alta')) has-danger @endif">
                        ...
                        <input type="text" class="form-control" name="descricao_motivo_cancelamento_alta"
                            value="{{ old('descricao_motivo_cancelamento_alta') }}">
