...
@section('conteudo')
    ...
    @component('components/page-title', [
        'titulo' => 'Cadastrar Motivo de Alta',
        'breadcrumb' => [
    ...
    <div class="card">
        <div class="card-body ">
            <form action="{{ route('instituicao.internacao.motivos-altas.store') }}" method="post">
                @csrf
                ...
                <div class="row">
                    <div wire:ignore class="col-md-7 form-group @if($errors->has('descricao_motivo_alta')) has-danger @endif">
                        ...
                        <input type="text" class="form-control" name="descricao_motivo_alta" value="{{ old('descricao_motivo_alta') }}">
                    ...
                    <div class="col-md-5 form-group @if($errors->has('tipo')) has-danger @endif">
                        ...
                        <select class="form-control p-0 m-0" name="tipo">
                            ...
                            @foreach ($tipos as $tipo)
                                <option value="{{ $tipo }}" @if (old('tipo')==$tipo)
                                    selected
                ...
                <div class="row">
                    <div class="col-md-5 form-group @if($errors->has('codigo_alta_sus')) has-danger @endif">
                        ...
                        <input type="number" class="form-control" name="codigo_alta_sus" value="{{ old('codigo_alta_sus') }}">
