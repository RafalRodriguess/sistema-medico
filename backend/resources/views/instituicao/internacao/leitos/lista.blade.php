...
@section('conteudo')
    ...
    <div class='row page-titles'>
            <div class='col-md-12 align-self-center'>
                <h3 class='text-themecolor m-b-0 m-t-0'>Leitos</h3>
                <ol class='breadcrumb'>
                    <li class='breadcrumb-item'>
                        <a href='{{ route('instituicao.internacao.unidade-internacao.index') }}'>
                            Unidades de Internação</a>
                    </li>
                    <li class='breadcrumb-item active'>
                        Leitos da Unidade de Internação #{{ $unidade_internacao->id }} {{ $unidade_internacao->nome }}
                    </li>
                </ol>
            </div>
        ...
        <div class='row'>
            <div class='col-12'>
                <!-- Column -->
                <div class='card'>
                    @livewire('instituicao.leitos-pesquisa', ['unidade_internacao' => $unidade_internacao])
                </div>
                <!-- Column -->
