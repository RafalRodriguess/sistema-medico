...
@section('conteudo')
    @component('components/page-title', [
        'titulo' => 'Editar entrada de estoque',
        'breadcrumb' => [
    ...
    <div class="card">
        <form action="{{ route('instituicao.estoque_entrada.update', $entradaEstoque) }}" method="POST">
            <div class="card-body row">
                        ...
                        <select name="id_tipo_documento"
                            ...
                            @foreach ($tiposDocumentos as $tiposDocumento)
                                <option value="{{ $tiposDocumento->id }}"
                                    @if (old('id_tipo_documento', $entradaEstoque->id_tipo_documento) == $tiposDocumento->id) selected="selected" @endif>
                        ...
                        <select name="id_estoque"
                            ...
                            @foreach ($estoques as $estoque)
                                <option value="{{ $estoque->id }}"
                                    @if (old('id_estoque', $entradaEstoque->id_estoque) == $estoque->id) selected="selected" @endif>
                                    {{ $estoque->descricao }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group @if ($errors->has('consignado')) has-danger @endif">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="consignado" value="1" id="consignado1"
                                @if (old('consignado', $entradaEstoque->consignado) == 1) checked @endif>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="consignado" value="0" id="consignado2"
                                @if (old('consignado', $entradaEstoque->consignado) == 0) checked @endif>
                    ...
                    <div class="form-group num_parcelas">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="contabiliza" value="1"
                                id="contabiliza1" @if (old('contabiliza', $entradaEstoque->contabiliza) == 1) checked @endif>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="contabiliza" value="0"
                                id="contabiliza2" @if (old('contabiliza', $entradaEstoque->contabiliza) == 0) checked @endif>
                ...
                <div class="col-sm-6">
                    <div class="form-group @if ($errors->has('numero_documento')) has-danger @endif">
                        ...
                        <input type="text" name="numero_documento"
                            value="{{ old('numero_documento', $entradaEstoque->numero_documento) }}"
                ...
                <div class="col-sm-6">
                    <div class="form-group @if ($errors->has('serie')) has-danger @endif">
                        ...
                        <input type="text" name="serie" value="{{ old('serie', $entradaEstoque->serie) }}"
                    ...
                    <div class="form-group @error('id_fornecedor') has-danger @enderror">
                        ...
                        <select id="id_fornecedor" name="id_fornecedor"
                            ...
                            @foreach ($fornecedores as $key => $fornecedor)
                                <option value="{{ $fornecedor->id }}" @if (old('id_fornecedor', $entradaEstoque->id_fornecedor) == $fornecedor->id) selected @endif>
                ...
                <div class="col-sm-6">
                    <div class="form-group @if ($errors->has('data_emissao')) has-danger @endif">
                        ...
                        <input type="date" name="data_emissao"
                            value="{{ old('data_emissao', (new \DateTime($entradaEstoque->data_emissao))->format('Y-m-d')) }}"
                ...
                <div class="col-sm-6">
                    <div class="form-group @if ($errors->has('data_hora_entrada')) has-danger @endif">
                        ...
                        <input type="time" name="data_hora_entrada"
                            value="{{ old('data_hora_entrada', $entradaEstoque->data_hora_entrada) }}"
    ...
    <script type="text/template" id="template-produto">
        <div class="col-md-12 item-produto">
            <div class="row">
                ...
                <input type="hidden" data-name="entrada-estoque-id" name="produtos[#][id_entrada_produto]">
    ...
    <script>
        ...
        function adicionarProduto(produto = {}) {
            ...
            produto_container.append(produto_template.create({
                    ...
                    'entrada-estoque-id': produto.id_entrada_produto ?? null,
                    'produto_id': {
                        option: {
                            value: produto.id,
                            text: `#${produto.id} - ${produto.descricao} [un: ${produto.unidade}]`
                        },
                        error: 'id'
                    },
                    'valor_custo': {
