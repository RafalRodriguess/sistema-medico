...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        <h3 class="text-themecolor m-b-0 m-t-0">Setores de exame</h3>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Instituição</a></li>
            <li class="breadcrumb-item active">Setores de exame</li>
        </ol>
    </div>
...
<div class="row">
    <div class="col-12">
        <!-- Column -->
        <div class="card">
         @livewire('instituicao.setores-exame-pesquisa')
        </div>
        <!-- Column -->
