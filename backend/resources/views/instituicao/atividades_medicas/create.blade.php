...
@section('conteudo')
    @component('components/page-title', [
        ...
        'breadcrumb' => ['Prestadores', 'Atividades médicas' => route('instituicao.atividadesMedicas.index'), 'Novo'],
    ])
    @endcomponent

    <div class="card">
        <form action="{{ route('instituicao.atividadesMedicas.store') }}" method="POST">
            <div class="card-body">
