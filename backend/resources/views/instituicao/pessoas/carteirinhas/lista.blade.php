...
@section('conteudo')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Carteirinhas</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('instituicao.pessoas.index', [$pessoa]) }}">Pacientes</a></li>
                <li class="breadcrumb-item active">Carteirinhas de convenios de paciente #{{ $pessoa->id }} {{$pessoa->nome}}</li>
            </ol>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <!-- Column -->
            <div class="card">
                @livewire('instituicao.carteirinhas-pesquisa', ['pessoa' => $pessoa])
            </div>
            <!-- Column -->
