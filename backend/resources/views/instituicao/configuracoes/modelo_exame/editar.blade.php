...
@section('conteudo')
    ...
    @component('components/page-title', [
        'titulo' => "Editar Modelo de exame #{$modelo->id} {$modelo->descricao}",
        'breadcrumb' => [
            'Modelo de exame' => route('instituicao.modeloExame.index'),
            'Editar',
        ],
    ])
    @endcomponent
    ...
    <div class="card">
        <div class="card-body ">
            <form action="{{ route('instituicao.modeloExame.update', [$modelo]) }}" method="post">
                @csrf
                @method('put')
               <div class="row">
                ...
                <div class="form-group text-right pb-2">
                    <a href="{{ route('instituicao.modeloExame.index') }}">
