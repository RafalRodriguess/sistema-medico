...
@section('conteudo')
    ...
    <div class="card">
        <div class="card-body ">
            <form action="{{ route('instituicao.modelosRecibo.store') }}" method="post">
                @csrf
               <div class="row">
                    ...
                    <div class=" col-md-3 form-group @if($errors->has('vias')) has-danger @endif">
                        ...
                        <input type="text" alt='numeric' name="vias" value="{{ old('vias') }}"
                    ...
                    <div class=" col-md-12 form-group @if($errors->has('texto')) has-danger @endif">
                        ...
                        <textarea class="form-control summernote @if($errors->has('texto')) form-control-danger @endif" name="texto" id="texto" cols="30" rows="10">{{ old('texto') }}</textarea>
                        @if($errors->has('texto'))
