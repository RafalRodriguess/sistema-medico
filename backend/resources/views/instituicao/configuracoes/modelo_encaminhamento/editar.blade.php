...
@section('conteudo')
    ...
    @component('components/page-title', [
        'titulo' => "Editar Modelo de encaminhamento #{$modelo->id} {$modelo->descricao}",
        'breadcrumb' => [
            'Modelo de encaminhamento' => route('instituicao.modeloEncaminhamento.index'),
            'Editar',
        ],
    ])
    @endcomponent
    ...
    <div class="card">
        <div class="card-body ">
            <form action="{{ route('instituicao.modeloEncaminhamento.update', [$modelo]) }}" method="post">
                @csrf
                @method('put')
               <div class="row">
                    ...
                    <div class=" col-md-12 form-group @if($errors->has('texto')) has-danger @endif">
                        ...
                        <textarea class="form-control summernote @if($errors->has('texto')) form-control-danger @endif" name="texto" id="texto" cols="30" rows="10">
                            {{ old('texto', $modelo->texto) }}</textarea>
                        @if($errors->has('texto'))
                ...
                <div class="form-group text-right pb-2">
                    <a href="{{ route('instituicao.modeloEncaminhamento.index') }}">
