...
@section('conteudo')
    ...
    @component('components/page-title', [
        'titulo' => 'Cadastrar Modelo de prontuário',
        'breadcrumb' => [
    ...
    <div class="card">
        <div class="card-body ">
            <form action="{{ route('instituicao.modeloProntuario.store') }}" method="post">
                @csrf
               <div class="row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <select class="form-control" name="modelo" id="modelo">
                            <option value="livre" selected>Prontuário livre</option>
                            <option value="padrao">Prontuário padrão</option>
                        </select>
                    </div>

                    <div class=" col-md-12 form-group livre">
                        <label class="form-control-label p-0 m-0">Texto *</label>
                        <textarea class="form-control summernote" name="texto" id="texto" cols="30" rows="10"></textarea>
                    </div>
