...
@section('conteudo')
    ...
    @component('components/page-title', [
        'titulo' => 'Cadastrar Modelo de laudo',
        'breadcrumb' => [
            'Modelo de laudo' => route('instituicao.modeloLaudo.index'),
            'Novo',
        ],
    ])
    @endcomponent
    ...
    <div class="card">
        <div class="card-body ">
            <form action="{{ route('instituicao.modeloLaudo.store') }}" method="post">
                @csrf
               <div class="row">
                    ...
                    <div class=" col-md-12 form-group @if($errors->has('texto')) has-danger @endif">
                        <label class="form-control-label p-0 m-0">Texto * <small class="form-control-feedback">Para acessar variaveis de texto digite "{"</small></label>
                ...
                <div class="form-group text-right pb-2">
                    <a href="{{ route('instituicao.modeloLaudo.index') }}">
