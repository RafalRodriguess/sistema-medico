...
@section('conteudo')
    @component('components/page-title', [
        'titulo' => "Editar hablidade usuário #{$instituicaoUsuario->id} {$instituicaoUsuario->nome}",
        'breadcrumb' => [
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('instituicao.instituicoes_usuarios.habilidade', [$instituicaoUsuario]) }}" method="post">
                @method('put')
                @csrf
