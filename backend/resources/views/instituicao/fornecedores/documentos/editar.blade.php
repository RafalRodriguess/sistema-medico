...
@section('conteudo')
    ...
    @component('components/page-title', [
        ...
        'breadcrumb' => [
            "Documentos do fornecedor #$fornecedor->id" => route('instituicao.fornecedores.documentos.index', [$fornecedor]),
            'Atualizar',
        ],
    ])
    @endcomponent
    ...
    <div class="card">
        <div class="card-body ">
            <form action="{{ route('instituicao.fornecedores.documentos.update', [$fornecedor, $documento]) }}" method="post" enctype="multipart/form-data">
                @method('put')
                @csrf
                <div class="row p-2">
                    <div class="col-sm-2">
