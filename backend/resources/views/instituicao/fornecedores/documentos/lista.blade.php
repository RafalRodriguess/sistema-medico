...
@section('conteudo')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('instituicao.fornecedores.index', [$fornecedor]) }}">Fornecedores</a></li>
                <li class="breadcrumb-item active">Documentos do fornecedor #{{ $fornecedor->id }}</li>
            </ol>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <!-- Column -->
            <div class="card">
                @livewire('instituicao.fornecedores-documentos-pesquisa', ['fornecedor' => $fornecedor])
            </div>
            <!-- Column -->
