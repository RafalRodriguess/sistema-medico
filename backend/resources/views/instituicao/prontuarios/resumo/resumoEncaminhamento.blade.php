<div class="modal inmodal fade bs-example-modal-lg" id="modalEncaminhamentoResumo" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <a class="list-group-item list-group-item-action menu-lista" href="#list-item-1">{{ date('d/m/Y', strtotime($encaminhamento->created_at) ) }} - {{$encaminhamento->usuario->nome}}</a>
                <div class="item-lista">
                    <h4 id="list-item-1" class="item">Encaminhamento</h4>
