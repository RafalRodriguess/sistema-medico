            ...
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="valor" id="autocomplete" class="form-control" required>
                                    </div>
                                </div>

                                <div class="col-md-6 form-group @if($errors->has('cidade')) has-danger @endif">
                                    <label class="form-control-label">Cidade: *</span></label>
                                    <input type="text" name="cidade" class="cidadeGmap form-control" readonly>
                                ...
                                <div class="col-md-6 form-group @if($errors->has('bairro')) has-danger @endif">
                                    ...
                                    <input type="text" name="bairro" class="bairroGmap form-control" readonly>
                ...
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group @if($errors->has('valor_minimo')) has-danger @endif">
                            <label class="form-control-label">Valor mínimo: *</label>
                            <div class="input-group ">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">R$</span>
                                </div>
                                <input type="text" name="valor_minimo" alt="money" class="form-control" value="" required>
