...
'titulo' => "Editar Bairro #{$filtro->id} {$filtro->bairro}({$filtro->cidade})",
'breadcrumb' => [
'Fretes',
                        ...
                        <div class="container" id="locationField">
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group">
                                    <label>Insira o nome do bairro e da cidade:</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fa fa-map"></i></span>
                                        </div>
                                        <input type="text" name="valor" id="autocomplete" class="form-control">
                                    </div>
                                </div>

                                <div class="col-md-6 form-group @if($errors->has('cidade')) has-danger @endif">
                                    <label class="form-control-label">Cidade: *</span></label>
                                    <input type="text" name="cidade" value="{{ old('cidade', $filtro->cidade) }}" class="cidadeGmap form-control @if($errors->has('cidade')) form-control-danger @endif" required readonly>
                                    @if($errors->has('cidade'))
                                    <div class="form-control-feedback">{{ $errors->first('cidade') }}</div>
                                    @endif
                                </div>

                                <div class="col-md-6 form-group @if($errors->has('bairro')) has-danger @endif">
                                    <label class="form-control-label">Bairro: *</span></label>
                                    <input type="text" name="bairro" value="{{ old('bairro', $filtro->bairro) }}" class="bairroGmap form-control @if($errors->has('bairro')) form-control-danger @endif" required readonly>
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group @if($errors->has('valor')) has-danger @endif">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="valor" alt="money" required value="{{ old('bairro', $filtro->valor) }}" class="form-control @if($errors->has('valor')) form-control-danger @endif">
                                @if($errors->has('valor'))
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="valor_minimo" alt="money" class="form-control " value="{{$filtro->valor_minimo}}" required>
                ...
                if (results[0]) {
                    ...
                    $.each(componentForm, function(key, value) {
                        ...
                        for (var i = 0; i < result.address_components.length; i++) {
                            ...
                            if (addressType.includes(itemAddress)) {
                                var val = result.address_components[i][name];
                                $('.' + key).val(val)
