...
@section('conteudo')
    @component('components/page-title', [
        'titulo' => 'Cadastrar Usuários Comercial',
        'breadcrumb' => [
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('comercial.comerciais_usuarios.store') }}" method="post" enctype="multipart/form-data">
                @csrf
    ...
    <script>
        $('#cpf').on('blur', function(){
            ...
            $.ajax({
                type: "GET",
                data: {cpf: cpf},
                url: "{{route('comercial.verificaCpfExistente')}}",
                datatype: "json",
         ...
         $( document ).ready(function() {
            ...
            $("form").submit(function(e){
                ...
                $.ajax("{{ route('comercial.comerciais_usuarios.store') }}", {
                    method: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function (response) {
                        ...
                        if(response.icon=="success"){
                            window.location="{{ route('comercial.comerciais_usuarios.index') }}";
                        }
                    },
