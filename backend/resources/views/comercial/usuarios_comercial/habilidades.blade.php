...
@section('conteudo')
    @component('components/page-title', [
        'titulo' => "Editar hablidade usuário #{$comercialUsuario->id} {$comercialUsuario->nome}",
        'breadcrumb' => [
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('comercial.comerciais_usuarios.habilidade', [$comercialUsuario]) }}" method="post">
                @method('put')
                @csrf
