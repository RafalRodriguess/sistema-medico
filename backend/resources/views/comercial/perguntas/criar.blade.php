...
@section('conteudo')
    @component('components/page-title', [
        'titulo' => "Cadastrar pergunta #{$produto->id} {$produto->nome}",
        'breadcrumb' => [
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('comercial.produtoPerguntas.store', [$produto]) }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group @error('tipo') has-danger @enderror">
                    ...
                    <select name="tipo" id="tipo"
                        class="form-control @error('tipo') form-control-danger @enderror" onchange="tipoAlternativas()">
                            <option value="Texto" @if (old('tipo') == "Texto")
                                selected="selected"
                            @endif>Texto</option>
                            <option value="Escolha Simples" @if (old('tipo') == "Escolha Simples")
                                selected="selected"
                            @endif>Escolha Simples</option>
                            <option value="Escolha Multipla" @if (old('tipo') == "Escolha Multipla")
                                selected="selected"
                            @endif>Escolha Multipla</option>
                            <option value="Contador" @if (old('tipo') == "Contador")
                                selected="selected"
                ...
                <div class="quantidade">
                    ...
                    <div class="form-group contador ">
                        ...
                        <input type="number" name="quantidade_maxima" value="{{ old('quantidade_maxima') }}"
                            class="form-control">
