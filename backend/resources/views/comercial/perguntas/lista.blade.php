...
@section('conteudo')
                ...
                <div class="row page-titles">
                        ...
                        <h3 class="text-themecolor m-b-0 m-t-0">Perguntas #{{ $produto->id }} {{ $produto->nome }}</h3>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Loja</a></li>
                                <li class="breadcrumb-item"><a href="{{ route('comercial.produtos.index') }}">Produtos</a></li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <!-- Column -->
                            <div class="card">
                                @livewire('comercial.produto-pergunta-pesquisa', ['produto' => $produto])
                            </div>
                            <!-- Column -->
