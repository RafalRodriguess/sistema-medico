...
class CreateTableConclusaoPaciente extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('conclusoes_paciente', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
            $table->softDeletes();
    ...
    {
        Schema::dropIfExists('conclusoes_paciente');
    }
}
